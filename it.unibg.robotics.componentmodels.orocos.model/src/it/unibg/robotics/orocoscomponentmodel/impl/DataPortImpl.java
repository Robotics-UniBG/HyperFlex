 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.orocoscomponentmodel.impl.DataPortImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataPortImpl extends EObjectImpl implements DataPort {
	...
	protected EClass eStaticClass() {
		return orocoscomponentmodelPackage.Literals.DATA_PORT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, orocoscomponentmodelPackage.DATA_PORT__NAME, oldName, name));
	}
