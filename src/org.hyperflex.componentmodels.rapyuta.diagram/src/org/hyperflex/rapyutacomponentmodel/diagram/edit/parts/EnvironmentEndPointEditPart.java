...
import org.hyperflex.rapyutacomponentmodel.diagram.edit.policies.EnvironmentEndPointCanonicalEditPolicy;
import org.hyperflex.rapyutacomponentmodel.diagram.edit.policies.EnvironmentEndPointItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EnvironmentEndPointEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public EnvironmentEndPointEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EnvironmentEndPointItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new EnvironmentEndPointCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EnvironmentEndPointNameEditPart) {
			((EnvironmentEndPointNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureEndPointNameLabel());
			return true;
		}
		if (childEditPart instanceof EnvironmentEndPointEndPointPropertiesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureEndPointProperties();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((EnvironmentEndPointEndPointPropertiesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof EndPointPublisher2EditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
					PositionConstants.WEST);
			getBorderedFigure().getBorderItemContainer().add(
					((EndPointPublisher2EditPart) childEditPart).getFigure(),
					locator);
			return true;
		}
		if (childEditPart instanceof EndPointSubscriber2EditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
					PositionConstants.EAST);
			getBorderedFigure().getBorderItemContainer().add(
					((EndPointSubscriber2EditPart) childEditPart).getFigure(),
					locator);
			return true;
		}
		if (childEditPart instanceof EndPointSrvServer2EditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
					PositionConstants.WEST);
			getBorderedFigure().getBorderItemContainer().add(
					((EndPointSrvServer2EditPart) childEditPart).getFigure(),
					locator);
			return true;
		}
		if (childEditPart instanceof EndPointSrvClient2EditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
					PositionConstants.EAST);
			getBorderedFigure().getBorderItemContainer().add(
					((EndPointSrvClient2EditPart) childEditPart).getFigure(),
					locator);
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EnvironmentEndPointEndPointPropertiesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureEndPointProperties();
			pane.remove(((EnvironmentEndPointEndPointPropertiesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof EndPointPublisher2EditPart) {
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof EnvironmentEndPointEndPointPropertiesCompartmentEditPart) {
