...
import org.hyperflex.rapyutacomponentmodel.diagram.edit.policies.CloudContainerCanonicalEditPolicy;
import org.hyperflex.rapyutacomponentmodel.diagram.edit.policies.CloudContainerItemSemanticEditPolicy;
import org.hyperflex.rapyutacomponentmodel.diagram.part.RapyutaComponentModelVisualIDRegistry;

/**
 * @generated
 */
public class CloudContainerEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public CloudContainerEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CloudContainerItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new CloudContainerCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CloudContainerNameEditPart) {
			((CloudContainerNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureContainerNameLabel());
			return true;
		}
		if (childEditPart instanceof CloudContainerContainerCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureContainerComponentsArea();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((CloudContainerContainerCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CloudContainerContainerCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureContainerComponentsArea();
			pane.remove(((CloudContainerContainerCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
