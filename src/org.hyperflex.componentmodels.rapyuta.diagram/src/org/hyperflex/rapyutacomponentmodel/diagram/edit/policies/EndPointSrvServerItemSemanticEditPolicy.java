 ...
 * @generated
 */
public class EndPointSrvServerItemSemanticEditPolicy extends
		RapyutaComponentModelBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public EndPointSrvServerItemSemanticEditPolicy() {
		super(RapyutaComponentModelElementTypes.EndPointSrvServer_3061);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (RapyutaComponentModelVisualIDRegistry.getVisualID(incomingLink) == EndPointSrvConnectionEditPart.VISUAL_ID) {
