...
import org.hyperflex.rapyutacomponentmodel.diagram.edit.policies.NodeParameterItemSemanticEditPolicy;
import org.hyperflex.rapyutacomponentmodel.diagram.part.RapyutaComponentModelVisualIDRegistry;

/**
 * @generated
 */
public class NodeParameterEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public NodeParameterEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new NodeParameterItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof NodeParameterNameEditPart) {
			((NodeParameterNameEditPart) childEditPart)
