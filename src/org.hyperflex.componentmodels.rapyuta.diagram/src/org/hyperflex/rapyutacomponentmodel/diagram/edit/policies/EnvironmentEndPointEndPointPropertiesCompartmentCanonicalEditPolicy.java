...
public class EnvironmentEndPointEndPointPropertiesCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<RapyutaComponentModelNodeDescriptor> childDescriptors = RapyutaComponentModelDiagramUpdater
				.getEnvironmentEndPointEndPointPropertiesCompartment_7010SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<RapyutaComponentModelNodeDescriptor> childDescriptors = RapyutaComponentModelDiagramUpdater
				.getEnvironmentEndPointEndPointPropertiesCompartment_7010SemanticChildren((View) getHost()
						.getModel());
