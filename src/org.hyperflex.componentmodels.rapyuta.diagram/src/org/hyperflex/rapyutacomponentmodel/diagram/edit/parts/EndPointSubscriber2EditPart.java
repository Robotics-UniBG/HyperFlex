...
import org.hyperflex.rapyutacomponentmodel.diagram.edit.policies.EndPointSubscriber2ItemSemanticEditPolicy;
import org.hyperflex.rapyutacomponentmodel.diagram.providers.RapyutaComponentModelElementTypes;

/**
 * @generated
 */
public class EndPointSubscriber2EditPart extends AbstractBorderItemEditPart {
	 ...
	 * @generated
	 */
	public EndPointSubscriber2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EndPointSubscriber2ItemSemanticEditPolicy());
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == RapyutaComponentModelElementTypes.EndPointMsgConnection_4007) {
