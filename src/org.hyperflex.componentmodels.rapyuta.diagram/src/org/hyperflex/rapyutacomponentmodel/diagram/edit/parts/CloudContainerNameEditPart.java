 ...
 * @generated
 */
public class CloudContainerNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CloudContainerNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RapyutaComponentModelParserProvider
					.getParser(
							RapyutaComponentModelElementTypes.CloudContainer_2006,
							getParserElement(),
							RapyutaComponentModelVisualIDRegistry
									.getType(org.hyperflex.rapyutacomponentmodel.diagram.edit.parts.CloudContainerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
