...
import org.hyperflex.rapyutacomponentmodel.diagram.edit.policies.EndPointParameter2ItemSemanticEditPolicy;
import org.hyperflex.rapyutacomponentmodel.diagram.part.RapyutaComponentModelVisualIDRegistry;

/**
 * @generated
 */
public class EndPointParameter2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EndPointParameter2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EndPointParameter2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EndPointParameterName2EditPart) {
			((EndPointParameterName2EditPart) childEditPart)
