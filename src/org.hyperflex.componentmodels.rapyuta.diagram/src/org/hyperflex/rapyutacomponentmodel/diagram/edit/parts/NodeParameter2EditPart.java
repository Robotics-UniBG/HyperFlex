...
import org.hyperflex.rapyutacomponentmodel.diagram.edit.policies.NodeParameter2ItemSemanticEditPolicy;
import org.hyperflex.rapyutacomponentmodel.diagram.part.RapyutaComponentModelVisualIDRegistry;

/**
 * @generated
 */
public class NodeParameter2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public NodeParameter2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new NodeParameter2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof NodeParameterName2EditPart) {
			((NodeParameterName2EditPart) childEditPart)
