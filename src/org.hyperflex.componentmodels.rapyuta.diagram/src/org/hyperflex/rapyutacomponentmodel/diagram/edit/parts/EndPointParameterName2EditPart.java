...
import org.hyperflex.rapyutacomponentmodel.diagram.edit.policies.RapyutaComponentModelTextSelectionEditPolicy;
 ...
 * @generated
 */
public class EndPointParameterName2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public EndPointParameterName2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new RapyutaComponentModelTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RapyutaComponentModelParserProvider
					.getParser(
							RapyutaComponentModelElementTypes.EndPointParameter_3070,
							getParserElement(),
							RapyutaComponentModelVisualIDRegistry
									.getType(org.hyperflex.rapyutacomponentmodel.diagram.edit.parts.EndPointParameterName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					RapyutaComponentModelEditPartFactory
