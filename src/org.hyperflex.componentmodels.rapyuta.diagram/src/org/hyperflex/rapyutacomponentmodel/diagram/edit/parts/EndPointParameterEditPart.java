...
import org.hyperflex.rapyutacomponentmodel.diagram.edit.policies.EndPointParameterItemSemanticEditPolicy;
import org.hyperflex.rapyutacomponentmodel.diagram.part.RapyutaComponentModelVisualIDRegistry;

/**
 * @generated
 */
public class EndPointParameterEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EndPointParameterEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EndPointParameterItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EndPointParameterNameEditPart) {
			((EndPointParameterNameEditPart) childEditPart)
