 ...
 * @generated
 */
public class RapyutaComponentModelDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public RapyutaComponentModelDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof RapyutaComponentModelDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((RapyutaComponentModelDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new RapyutaComponentModelDomainNavigatorItem(
