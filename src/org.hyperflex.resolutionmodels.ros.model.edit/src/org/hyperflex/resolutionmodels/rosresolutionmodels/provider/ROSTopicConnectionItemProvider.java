...
/**
 * This is the item provider adapter for a {@link org.hyperflex.resolutionmodels.rosresolutionmodels.ROSTopicConnection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addMessageInterfacePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ROSTopicConnection_messageInterface_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ROSTopicConnection_messageInterface_feature", "_UI_ROSTopicConnection_type"),
				 rosresolutionmodelsPackage.Literals.ROS_TOPIC_CONNECTION__MESSAGE_INTERFACE,
				 true,
				 false,
				 true,
				 null,
