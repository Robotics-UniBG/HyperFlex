 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.resolutionmodels.rttresolutionmodels.impl.RTTConnectionImpl#getName <em>Name</em>}</li>
 *   <li>{@link it.unibg.robotics.resolutionmodels.rttresolutionmodels.impl.RTTConnectionImpl#getType <em>Type</em>}</li>
 *   <li>{@link it.unibg.robotics.resolutionmodels.rttresolutionmodels.impl.RTTConnectionImpl#getLockPolicy <em>Lock Policy</em>}</li>
 *   <li>{@link it.unibg.robotics.resolutionmodels.rttresolutionmodels.impl.RTTConnectionImpl#getBufferSize <em>Buffer Size</em>}</li>
 *   <li>{@link it.unibg.robotics.resolutionmodels.rttresolutionmodels.impl.RTTConnectionImpl#getInputPort <em>Input Port</em>}</li>
 *   <li>{@link it.unibg.robotics.resolutionmodels.rttresolutionmodels.impl.RTTConnectionImpl#getOutputPort <em>Output Port</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RTTConnectionImpl extends EObjectImpl implements RTTConnection {
	...
	protected EClass eStaticClass() {
		return rttresolutionmodelsPackage.Literals.RTT_CONNECTION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rttresolutionmodelsPackage.RTT_CONNECTION__NAME, oldName, name));
	}
	...
	public void setType(ConnectionPolicyType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rttresolutionmodelsPackage.RTT_CONNECTION__TYPE, oldType, type));
	}
	...
	public void setLockPolicy(ConnectionPolicyLockPolicy newLockPolicy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rttresolutionmodelsPackage.RTT_CONNECTION__LOCK_POLICY, oldLockPolicy, lockPolicy));
	}
	...
	public void setBufferSize(short newBufferSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rttresolutionmodelsPackage.RTT_CONNECTION__BUFFER_SIZE, oldBufferSize, bufferSize));
	}
	...
	public InputPort getInputPort() {
		if (inputPort != null && inputPort.eIsProxy()) {
			...
			if (inputPort != oldInputPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, rttresolutionmodelsPackage.RTT_CONNECTION__INPUT_PORT, oldInputPort, inputPort));
			}
		}
		return inputPort;
	}
	...
	public void setInputPort(InputPort newInputPort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rttresolutionmodelsPackage.RTT_CONNECTION__INPUT_PORT, oldInputPort, inputPort));
	}
	...
	public OutputPort getOutputPort() {
		if (outputPort != null && outputPort.eIsProxy()) {
			...
			if (outputPort != oldOutputPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, rttresolutionmodelsPackage.RTT_CONNECTION__OUTPUT_PORT, oldOutputPort, outputPort));
			}
		}
		return outputPort;
	}
	...
	public void setOutputPort(OutputPort newOutputPort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rttresolutionmodelsPackage.RTT_CONNECTION__OUTPUT_PORT, oldOutputPort, outputPort));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case rttresolutionmodelsPackage.RTT_CONNECTION__NAME:
				return getName();
			case rttresolutionmodelsPackage.RTT_CONNECTION__TYPE:
				return getType();
			case rttresolutionmodelsPackage.RTT_CONNECTION__LOCK_POLICY:
				return getLockPolicy();
			case rttresolutionmodelsPackage.RTT_CONNECTION__BUFFER_SIZE:
				return getBufferSize();
			case rttresolutionmodelsPackage.RTT_CONNECTION__INPUT_PORT:
				if (resolve) return getInputPort();
				return basicGetInputPort();
			case rttresolutionmodelsPackage.RTT_CONNECTION__OUTPUT_PORT:
