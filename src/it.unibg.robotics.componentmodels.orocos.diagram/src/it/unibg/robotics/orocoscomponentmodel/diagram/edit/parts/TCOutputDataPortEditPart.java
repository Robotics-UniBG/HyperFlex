...
import it.unibg.robotics.orocoscomponentmodel.diagram.edit.policies.TCOutputDataPortItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TCOutputDataPortEditPart extends AbstractBorderItemEditPart {
	 ...
	 * @generated
	 */
	public TCOutputDataPortEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TCOutputDataPortItemSemanticEditPolicy());
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		...
		if (relationshipType == OrocosComponentModelElementTypes.ConnectionPolicy_4001) {
		...
		} else if (relationshipType == OrocosComponentModelElementTypes.CompOutputPort_4004) {
