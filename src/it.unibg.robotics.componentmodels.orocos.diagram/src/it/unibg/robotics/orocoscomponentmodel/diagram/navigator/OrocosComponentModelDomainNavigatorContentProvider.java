 ...
 * @generated
 */
public class OrocosComponentModelDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public OrocosComponentModelDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof OrocosComponentModelDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((OrocosComponentModelDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new OrocosComponentModelDomainNavigatorItem(
