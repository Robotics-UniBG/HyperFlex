...
import it.unibg.robotics.orocoscomponentmodel.diagram.edit.policies.OrocosComponentModelTextSelectionEditPolicy;
 ...
 * @generated
 */
public class TCPropertyNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TCPropertyNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new OrocosComponentModelTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OrocosComponentModelParserProvider
					.getParser(
							OrocosComponentModelElementTypes.TCProperty_3016,
							getParserElement(),
							OrocosComponentModelVisualIDRegistry
									.getType(it.unibg.robotics.orocoscomponentmodel.diagram.edit.parts.TCPropertyNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					OrocosComponentModelEditPartFactory
