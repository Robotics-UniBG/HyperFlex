...
import it.unibg.robotics.orocoscomponentmodel.diagram.edit.policies.CompOperationCaller2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CompOperationCaller2EditPart extends AbstractBorderItemEditPart {
	 ...
	 * @generated
	 */
	public CompOperationCaller2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CompOperationCaller2ItemSemanticEditPolicy());
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == OrocosComponentModelElementTypes.PeersConnection_4007) {
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == OrocosComponentModelElementTypes.CompOperationCaller_4009) {
