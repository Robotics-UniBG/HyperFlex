 ...
 * @generated
 */
public class CompOperationCallerNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				OrocosComponentModelVisualIDRegistry
						.getType(it.unibg.robotics.orocoscomponentmodel.diagram.edit.parts.CompOperationCallerNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public CompOperationCallerNameEditPart(View view) {
		super(view);
	}
