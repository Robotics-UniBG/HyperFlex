 ...
 * @generated
 */
public class CompositeName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CompositeName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OrocosComponentModelParserProvider
					.getParser(
							OrocosComponentModelElementTypes.Composite_3005,
							getParserElement(),
							OrocosComponentModelVisualIDRegistry
									.getType(it.unibg.robotics.orocoscomponentmodel.diagram.edit.parts.CompositeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
