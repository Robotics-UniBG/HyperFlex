 ...
 * @generated
 */
public class CompOutputPortNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				OrocosComponentModelVisualIDRegistry
						.getType(it.unibg.robotics.orocoscomponentmodel.diagram.edit.parts.CompOutputPortNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public CompOutputPortNameEditPart(View view) {
		super(view);
	}
