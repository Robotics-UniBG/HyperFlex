...
import it.unibg.robotics.orocoscomponentmodel.diagram.edit.commands.CompInputPort2CreateCommand;
...
import it.unibg.robotics.orocoscomponentmodel.diagram.edit.commands.CompOperation2CreateCommand;
import it.unibg.robotics.orocoscomponentmodel.diagram.edit.commands.CompOperation3CreateCommand;
import it.unibg.robotics.orocoscomponentmodel.diagram.edit.commands.CompOperationCaller2CreateCommand;
...
import it.unibg.robotics.orocoscomponentmodel.diagram.edit.commands.CompOutputPort2CreateCommand;
...
public class CompositeItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (OrocosComponentModelElementTypes.CompInputPort_3008 == req
				.getElementType()) {
			return getGEFWrapper(new CompInputPort2CreateCommand(req));
		}
		if (OrocosComponentModelElementTypes.CompOutputPort_3009 == req
				.getElementType()) {
			return getGEFWrapper(new CompOutputPort2CreateCommand(req));
		}
		if (OrocosComponentModelElementTypes.CompOperation_3014 == req
				.getElementType()) {
			return getGEFWrapper(new CompOperation2CreateCommand(req));
		}
		if (OrocosComponentModelElementTypes.CompOperationCaller_3015 == req
				.getElementType()) {
