...
import it.unibg.robotics.orocoscomponentmodel.diagram.edit.policies.CompInputPort3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CompInputPort3EditPart extends ConnectionNodeEditPart implements
		ITreeBranchEditPart {
	 ...
	 * @generated
	 */
	public CompInputPort3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CompInputPort3ItemSemanticEditPolicy());
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CompInputPortNameEditPart) {
			((CompInputPortNameEditPart) childEditPart)
