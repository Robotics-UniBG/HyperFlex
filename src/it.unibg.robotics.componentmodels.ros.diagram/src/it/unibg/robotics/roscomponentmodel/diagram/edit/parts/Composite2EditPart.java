...
import it.unibg.robotics.roscomponentmodel.diagram.edit.policies.Composite2CanonicalEditPolicy;
import it.unibg.robotics.roscomponentmodel.diagram.edit.policies.Composite2ItemSemanticEditPolicy;
...
public class Composite2EditPart extends AbstractBorderedShapeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CompositeMsgProducerEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
					PositionConstants.WEST);
			getBorderedFigure().getBorderItemContainer().add(
					((CompositeMsgProducerEditPart) childEditPart).getFigure(),
					locator);
			return true;
		}
