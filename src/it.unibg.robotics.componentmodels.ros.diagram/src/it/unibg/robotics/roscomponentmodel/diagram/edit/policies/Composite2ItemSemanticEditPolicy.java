...
import it.unibg.robotics.roscomponentmodel.diagram.edit.commands.CompositeMsgConsumerCreateCommand;
import it.unibg.robotics.roscomponentmodel.diagram.edit.commands.CompositeMsgProducerCreateCommand;
...
public class Composite2ItemSemanticEditPolicy extends
	...
	public Composite2ItemSemanticEditPolicy() {
		super(RosComponentModelElementTypes.Composite_3014);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (RosComponentModelElementTypes.CompositeMsgProducer_3015 == req
				.getElementType()) {
			return getGEFWrapper(new CompositeMsgProducerCreateCommand(req));
		}
		if (RosComponentModelElementTypes.CompositeMsgConsumer_3016 == req
				.getElementType()) {
