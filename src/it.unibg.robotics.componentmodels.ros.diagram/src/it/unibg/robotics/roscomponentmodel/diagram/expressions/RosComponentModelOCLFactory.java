 ...
 * @generated
 */
public class RosComponentModelOCLFactory {

	/**
	 * @generated
	 */
	private final RosComponentModelAbstractExpression[] expressions;
	 ...
	 * @generated
	 */
	private static RosComponentModelOCLFactory getInstance() {
		RosComponentModelOCLFactory instance = RosComponentModelDiagramEditorPlugin
				.getInstance().getRosComponentModelOCLFactory();
		if (instance == null) {
			RosComponentModelDiagramEditorPlugin.getInstance()
					.setRosComponentModelOCLFactory(
							instance = new RosComponentModelOCLFactory());
		}
		return instance;
	}
	 ...
	 * @generated
	 */
	public static RosComponentModelAbstractExpression getExpression(int index,
			EClassifier context, Map<String, EClassifier> environment) {
		RosComponentModelOCLFactory cached = getInstance();
	 ...
	 * @generated
	 */
	public static RosComponentModelAbstractExpression getExpression(
	 ...
	 * @generated
	 */
	private static class Expression extends RosComponentModelAbstractExpression {
