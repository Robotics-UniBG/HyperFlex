 ...
 * @generated
 */
public class RosComponentModelSheetLabelProvider extends BaseLabelProvider
	...
	public String getText(Object element) {
		...
		if (element instanceof RosComponentModelNavigatorGroup) {
			return ((RosComponentModelNavigatorGroup) element).getGroupName();
		}
	...
	public Image getImage(Object element) {
		...
		return etype == null ? null : RosComponentModelElementTypes
				.getImage(etype);
	}
	...
	private IElementType getElementType(View view) {
		...
		while (view != null) {
			int vid = RosComponentModelVisualIDRegistry.getVisualID(view);
			IElementType etype = RosComponentModelElementTypes
					.getElementType(vid);
			if (etype != null) {
				return etype;
			}
