...
import org.hyperflex.roscomponentmodel.diagram.edit.policies.WireItemSemanticEditPolicy;

/**
 * @generated
 */
public class WireEditPart extends ConnectionNodeEditPart implements
		ITreeBranchEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WireSrvNameEditPart) {
			((WireSrvNameEditPart) childEditPart).setLabel(getPrimaryShape()
