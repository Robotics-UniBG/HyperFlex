...
import org.hyperflex.roscomponentmodel.diagram.edit.policies.CompositeSrvConsumer2ItemSemanticEditPolicy;
import org.hyperflex.roscomponentmodel.diagram.providers.RosComponentModelElementTypes;

/**
 * @generated
 */
public class CompositeSrvConsumer2EditPart extends AbstractBorderItemEditPart {
	 ...
	 * @generated
	 */
	public CompositeSrvConsumer2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CompositeSrvConsumer2ItemSemanticEditPolicy());
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == RosComponentModelElementTypes.Wire_4007) {
