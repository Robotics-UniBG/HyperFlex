...
import org.hyperflex.roscomponentmodel.diagram.edit.policies.CompositeSrvProducer2ItemSemanticEditPolicy;
import org.hyperflex.roscomponentmodel.diagram.providers.RosComponentModelElementTypes;

/**
 * @generated
 */
public class CompositeSrvProducer2EditPart extends AbstractBorderItemEditPart {
	 ...
	 * @generated
	 */
	public CompositeSrvProducer2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CompositeSrvProducer2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Producer2Figure();
	}

	/**
	 * @generated
	 */
	public Producer2Figure getPrimaryShape() {
		return (Producer2Figure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.hyperflex.roscomponentmodel.diagram.edit.parts.CompositeSrvProducer2EditPart) {
			types.add(RosComponentModelElementTypes.CompositeSrvProducerPromote_4005);
		}
		if (targetEditPart instanceof NodeSrvProducerEditPart) {
			types.add(RosComponentModelElementTypes.CompositeSrvProducerPromote_4006);
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == RosComponentModelElementTypes.CompositeSrvProducerPromote_4005) {
		...
		} else if (relationshipType == RosComponentModelElementTypes.CompositeSrvProducerPromote_4006) {
			types.add(RosComponentModelElementTypes.NodeSrvProducer_3005);
			types.add(RosComponentModelElementTypes.CompositeSrvProducer_3010);
			types.add(RosComponentModelElementTypes.CompositeSrvProducer_3015);
		}
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		...
		if (relationshipType == RosComponentModelElementTypes.CompositeSrvProducerPromote_4005) {
			...
			types.add(RosComponentModelElementTypes.CompositeSrvProducer_3010);
			types.add(RosComponentModelElementTypes.CompositeSrvProducer_3015);
		} else if (relationshipType == RosComponentModelElementTypes.Wire_4007) {
	 ...
	 * @generated
	 */
	public class Producer2Figure extends RectangleFigure {

		/**
		 * @generated
		 */
		public Producer2Figure() {
