 ...
 * @generated
 */
public class MsgInterfaceConnection2CreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MsgInterfaceConnection2CreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof MsgInterface) {
			return false;
		}
		...
		return RosComponentModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateMsgInterfaceConnection_4002(getSource(), getTarget());
	}
	 ...
	 * @generated
	 */
	protected MsgInterface getSource() {
		return (MsgInterface) source;
	}
