 ...
 * @generated
 */
public class CompositeMsgInterfaceExposed3CreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public CompositeMsgInterfaceExposed3CreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof CompositeMsgInterface) {
			return false;
		}
		...
		return RosComponentModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateCompositeMsgInterfaceExposed_4004(getSource(),
						getTarget());
	}
	 ...
	 * @generated
	 */
	protected CompositeMsgInterface getSource() {
		return (CompositeMsgInterface) source;
	}
