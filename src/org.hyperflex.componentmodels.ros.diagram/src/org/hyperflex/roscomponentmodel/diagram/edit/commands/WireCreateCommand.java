...
public class WireCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof SrvConsumer) {
			return false;
		}
		...
		return RosComponentModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateWire_4007(getContainer(), getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Wire newElement = org.hyperflex.roscomponentmodel.roscomponentmodelFactory.eINSTANCE
				.createWire();
	 ...
	 * @generated
	 */
	protected void doConfigure(Wire newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
	 ...
	 * @generated
	 */
	protected SrvConsumer getSource() {
		return (SrvConsumer) source;
	}
