 ...
 * @generated
 */
public class CompositeSrvConsumer2ItemSemanticEditPolicy extends
		RosComponentModelBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public CompositeSrvConsumer2ItemSemanticEditPolicy() {
		super(RosComponentModelElementTypes.CompositeSrvConsumer_3016);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (RosComponentModelVisualIDRegistry.getVisualID(outgoingLink) == WireEditPart.VISUAL_ID) {
