 ...
 * @generated
 */
public class RosComponentModelDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public RosComponentModelDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof RosComponentModelDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((RosComponentModelDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new RosComponentModelDomainNavigatorItem(
