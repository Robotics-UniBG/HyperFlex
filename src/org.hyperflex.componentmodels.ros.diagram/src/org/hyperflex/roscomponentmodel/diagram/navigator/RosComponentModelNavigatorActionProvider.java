 ...
 * @generated
 */
public class RosComponentModelNavigatorActionProvider extends
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof RosComponentModelNavigatorItem) {
					selectedElement = ((RosComponentModelNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, RosComponentModelDiagramEditor.ID);
