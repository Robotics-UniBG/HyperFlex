 ...
 * @generated
 */
public class RosComponentModelInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new RosComponentModelNewDiagramFileWizard(
				domainModelURI, diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ArchitectureModelEditPart.MODEL_ID));
		RosComponentModelDiagramEditorUtil.runWizard(getShell(), wizard,
