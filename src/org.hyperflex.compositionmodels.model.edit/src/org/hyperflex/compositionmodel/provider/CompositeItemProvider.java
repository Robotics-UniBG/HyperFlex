...
public class CompositeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 compositionmodelPackage.Literals.COMPOSITE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(compositionmodelPackage.Literals.COMPOSITE__PROV_INTERFACES);
			childrenFeatures.add(compositionmodelPackage.Literals.COMPOSITE__REQ_INTERFACES);
			childrenFeatures.add(compositionmodelPackage.Literals.COMPOSITE__PROPERTIES);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(compositionmodelPackage.Literals.COMPOSITE__PROV_INTERFACES,
				 compositionmodelFactory.eINSTANCE.createSystemCompositeProvidedInterf()));

		newChildDescriptors.add
			(createChildParameter
				(compositionmodelPackage.Literals.COMPOSITE__REQ_INTERFACES,
				 compositionmodelFactory.eINSTANCE.createSystemCompositeRequiredInterf()));

		newChildDescriptors.add
			(createChildParameter
				(compositionmodelPackage.Literals.COMPOSITE__PROPERTIES,
				 compositionmodelFactory.eINSTANCE.createSystemCompositeProperty()));
	}
