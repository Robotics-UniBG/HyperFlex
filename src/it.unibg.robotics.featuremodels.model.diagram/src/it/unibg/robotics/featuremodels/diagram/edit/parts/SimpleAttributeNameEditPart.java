 ...
 * @generated
 */
public class SimpleAttributeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SimpleAttributeNameEditPart(View view) {
		super(view);
	}
			...
			parser = FeatureModelParserProvider
					.getParser(
							...
							FeatureModelVisualIDRegistry
									.getType(it.unibg.robotics.featuremodels.diagram.edit.parts.SimpleAttributeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
