...
public class FeatureSubFeaturesReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public FeatureSubFeaturesReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return FeatureModelBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistFeatureSubFeatures_4007(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return FeatureModelBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistFeatureSubFeatures_4007(getOldSource(), getNewTarget());
	}
