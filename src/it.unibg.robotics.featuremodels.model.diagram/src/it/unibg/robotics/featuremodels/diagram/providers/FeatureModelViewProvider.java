...
import it.unibg.robotics.featuremodels.diagram.edit.parts.ContainmentAssociationLowerBoundUpperBoundEditPart;
...
import it.unibg.robotics.featuremodels.diagram.edit.parts.FeatureName2EditPart;
import it.unibg.robotics.featuremodels.diagram.edit.parts.FeatureNameEditPart;
...
import it.unibg.robotics.featuremodels.diagram.edit.parts.SimpleAttributeNameEditPart;
 ...
 * @generated
 */
public class FeatureModelViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return FeatureModelEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = FeatureModelVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = FeatureModelVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!FeatureModelElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != FeatureModelVisualIDRegistry
				...
				if (!FeatureModelEditPart.MODEL_ID
						.equals(FeatureModelVisualIDRegistry.getModelID(op
								.getContainerView()))) {
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = FeatureModelVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(FeatureModelEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = FeatureModelVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case FeatureEditPart.VISUAL_ID:
		...
		case ContainmentAssociationEditPart.VISUAL_ID:
			return createContainmentAssociation_3001(domainElement,
	 ...
	 * @generated
	 */
	public Node createContainmentAssociation_3001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	...
	private void stampShortcut(View containerView, Node target) {
		if (!FeatureModelEditPart.MODEL_ID.equals(FeatureModelVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", FeatureModelEditPart.MODEL_ID); //$NON-NLS-1$
