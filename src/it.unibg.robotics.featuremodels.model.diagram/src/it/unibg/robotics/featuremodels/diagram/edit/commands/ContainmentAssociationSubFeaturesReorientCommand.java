 ...
 * @generated
 */
public class ContainmentAssociationSubFeaturesReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ContainmentAssociationSubFeaturesReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return FeatureModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistContainmentAssociationSubFeatures_4013(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return FeatureModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistContainmentAssociationSubFeatures_4013(getOldSource(),
						getNewTarget());
	}
