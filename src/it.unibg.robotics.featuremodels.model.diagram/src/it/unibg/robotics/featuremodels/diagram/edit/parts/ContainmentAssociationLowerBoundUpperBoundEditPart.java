...
import it.unibg.robotics.featuremodels.diagram.edit.policies.FeatureModelTextSelectionEditPolicy;
...
import it.unibg.robotics.featuremodels.diagram.providers.FeatureModelParserProvider;
 ...
 * @generated
 */
public class ContainmentAssociationLowerBoundUpperBoundEditPart extends
	 ...
	 * @generated
	 */
	public ContainmentAssociationLowerBoundUpperBoundEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new FeatureModelTextSelectionEditPolicy());
			...
			parser = FeatureModelParserProvider
					.getParser(
							...
							FeatureModelVisualIDRegistry
									.getType(it.unibg.robotics.featuremodels.diagram.edit.parts.ContainmentAssociationLowerBoundUpperBoundEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					FeatureModelEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
