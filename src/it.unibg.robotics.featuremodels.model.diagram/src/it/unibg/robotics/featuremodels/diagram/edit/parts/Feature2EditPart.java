...
import it.unibg.robotics.featuremodels.diagram.edit.policies.Feature2CanonicalEditPolicy;
import it.unibg.robotics.featuremodels.diagram.edit.policies.Feature2ItemSemanticEditPolicy;
import it.unibg.robotics.featuremodels.diagram.edit.policies.FeatureModelCanonicalEditPolicy;
import it.unibg.robotics.featuremodels.diagram.edit.policies.OpenDiagramEditPolicy;
...
public class Feature2EditPart extends AbstractBorderedShapeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof it.unibg.robotics.featuremodels.diagram.edit.parts.Feature2EditPart) {
			types.add(FeatureModelElementTypes.FeatureSubFeatures_4007);
		}
		if (targetEditPart instanceof FeatureEditPart) {
			types.add(FeatureModelElementTypes.FeatureSubFeatures_4008);
