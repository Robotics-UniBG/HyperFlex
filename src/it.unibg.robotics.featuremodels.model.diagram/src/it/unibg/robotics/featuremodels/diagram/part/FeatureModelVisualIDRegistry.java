...
public class FeatureModelVisualIDRegistry {
	...
	public static int getVisualID(View view) {
		...
		return it.unibg.robotics.featuremodels.diagram.part.FeatureModelVisualIDRegistry
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = it.unibg.robotics.featuremodels.diagram.part.FeatureModelVisualIDRegistry
		...
		if (FeatureModelEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = it.unibg.robotics.featuremodels.diagram.part.FeatureModelVisualIDRegistry
