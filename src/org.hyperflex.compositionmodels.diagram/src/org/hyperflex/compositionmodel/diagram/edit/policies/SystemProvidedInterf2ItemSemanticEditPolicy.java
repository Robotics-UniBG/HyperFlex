 ...
 * @generated
 */
public class SystemProvidedInterf2ItemSemanticEditPolicy extends
		CompositionModelBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public SystemProvidedInterf2ItemSemanticEditPolicy() {
		super(CompositionModelElementTypes.SystemProvidedInterf_3001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (CompositionModelVisualIDRegistry.getVisualID(outgoingLink) == CompositeSrvProducerPromoteEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
