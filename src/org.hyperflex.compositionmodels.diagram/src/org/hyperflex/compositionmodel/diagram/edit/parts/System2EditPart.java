 ...
 * @generated
 */
public class System2EditPart extends AbstractBorderedShapeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof SystemCompositeContainerCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureCompositeContainerComponentsArea();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((SystemCompositeContainerCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof SystemCompositeContainerCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureCompositeContainerComponentsArea();
			pane.remove(((SystemCompositeContainerCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof SystemProvidedInterf2EditPart) {
