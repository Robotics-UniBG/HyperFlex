 ...
 * @generated
 */
public class CompositeSrvProducerPromoteCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public CompositeSrvProducerPromoteCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof SystemProvidedInterf) {
			return false;
		}
		if (target != null && false == target instanceof ProvidedInterface) {
			return false;
		}
		if (getSource() == null) {
		...
		return CompositionModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateSystemProvidedInterfExposed_4003(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setExposed(getTarget());
		}
	 ...
	 * @generated
	 */
	protected SystemProvidedInterf getSource() {
		return (SystemProvidedInterf) source;
	}

	/**
	 * @generated
	 */
	protected ProvidedInterface getTarget() {
		return (ProvidedInterface) target;
	}
}
