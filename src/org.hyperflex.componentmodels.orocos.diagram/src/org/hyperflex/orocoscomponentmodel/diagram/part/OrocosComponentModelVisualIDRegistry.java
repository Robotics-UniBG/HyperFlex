...
public class OrocosComponentModelVisualIDRegistry {
	 ...
	 * @generated
	 */
	private static final String DEBUG_KEY = "org.hyperflex.componentmodels.orocos.diagram/debug/visualID"; //$NON-NLS-1$
	...
	public static int getVisualID(View view) {
		...
		return org.hyperflex.orocoscomponentmodel.diagram.part.OrocosComponentModelVisualIDRegistry
	...
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (org.hyperflex.orocoscomponentmodel.orocoscomponentmodelPackage.eINSTANCE
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = org.hyperflex.orocoscomponentmodel.diagram.part.OrocosComponentModelVisualIDRegistry
		...
		if (SystemEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = org.hyperflex.orocoscomponentmodel.diagram.part.OrocosComponentModelVisualIDRegistry
