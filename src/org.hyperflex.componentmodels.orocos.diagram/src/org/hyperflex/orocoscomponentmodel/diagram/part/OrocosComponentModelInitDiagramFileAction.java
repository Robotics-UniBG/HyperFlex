 ...
 * @generated
 */
public class OrocosComponentModelInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new OrocosComponentModelNewDiagramFileWizard(
				domainModelURI, diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				SystemEditPart.MODEL_ID));
		OrocosComponentModelDiagramEditorUtil.runWizard(getShell(), wizard,
