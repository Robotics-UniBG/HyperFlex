...
public class CompositeCompositeContainerCompartmentCanonicalEditPolicy extends
	...
	protected List getSemanticChildrenList() {
		...
		List<OrocosComponentModelNodeDescriptor> childDescriptors = OrocosComponentModelDiagramUpdater
				.getCompositeCompositeContainerCompartment_7003SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == TaskContextEditPart.VISUAL_ID
				|| visualID == Composite2EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<OrocosComponentModelNodeDescriptor> childDescriptors = OrocosComponentModelDiagramUpdater
				.getCompositeCompositeContainerCompartment_7003SemanticChildren((View) getHost()
						.getModel());
