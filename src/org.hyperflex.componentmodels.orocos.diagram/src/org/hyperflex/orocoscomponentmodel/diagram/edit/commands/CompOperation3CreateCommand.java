...
public class CompOperation3CreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return OrocosComponentModelBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateCompOperation_4014(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		CompOperation newElement = org.hyperflex.orocoscomponentmodel.orocoscomponentmodelFactory.eINSTANCE
				.createCompOperation();
