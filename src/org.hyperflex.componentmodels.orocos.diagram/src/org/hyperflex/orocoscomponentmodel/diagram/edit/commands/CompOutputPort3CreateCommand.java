...
public class CompOutputPort3CreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return OrocosComponentModelBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateCompOutputPort_4011(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		CompOutputPort newElement = org.hyperflex.orocoscomponentmodel.orocoscomponentmodelFactory.eINSTANCE
