...
import org.hyperflex.orocoscomponentmodel.diagram.edit.policies.TCOutputDataPortItemSemanticEditPolicy;
...
public class TCOutputDataPortEditPart extends AbstractBorderItemEditPart {
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		...
		if (relationshipType == OrocosComponentModelElementTypes.ConnectionPolicy_4010) {
		...
		} else if (relationshipType == OrocosComponentModelElementTypes.CompOutputPort_4011) {
