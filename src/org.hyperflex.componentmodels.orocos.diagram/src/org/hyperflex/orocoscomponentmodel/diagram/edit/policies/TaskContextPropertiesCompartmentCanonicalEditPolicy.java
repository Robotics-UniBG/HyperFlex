 ...
 * @generated
 */
public class TaskContextPropertiesCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<OrocosComponentModelNodeDescriptor> childDescriptors = OrocosComponentModelDiagramUpdater
				.getTaskContextPropertiesCompartment_7004SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<OrocosComponentModelNodeDescriptor> childDescriptors = OrocosComponentModelDiagramUpdater
				.getTaskContextPropertiesCompartment_7004SemanticChildren((View) getHost()
						.getModel());
