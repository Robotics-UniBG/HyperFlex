...
import org.hyperflex.orocoscomponentmodel.diagram.edit.policies.CompOperationCaller2ItemSemanticEditPolicy;
...
public class CompOperationCaller2EditPart extends AbstractBorderItemEditPart {
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == OrocosComponentModelElementTypes.PeersConnection_4013) {
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == OrocosComponentModelElementTypes.CompOperationCaller_4015) {
