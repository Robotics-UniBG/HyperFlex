 ...
 * @generated
 */
public class CompOperation3CreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CompOperation3CreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return OrocosComponentModelBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateCompOperation_4008(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		CompOperation newElement = it.unibg.robotics.orocoscomponentmodel.orocoscomponentmodelFactory.eINSTANCE
				.createCompOperation();
		getSource().getOperations().add(newElement);
		newElement.setExposedOp(getTarget());
	 ...
	 * @generated
	 */
	protected void doConfigure(CompOperation newElement,
