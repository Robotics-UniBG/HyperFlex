...
import it.unibg.robotics.orocoscomponentmodel.diagram.part.OrocosComponentModelDiagramEditor;
 ...
 * @generated
 */
public class OrocosComponentModelNavigatorActionProvider extends
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof OrocosComponentModelNavigatorItem) {
					selectedElement = ((OrocosComponentModelNavigatorItem) selectedElement)
							.getView();
