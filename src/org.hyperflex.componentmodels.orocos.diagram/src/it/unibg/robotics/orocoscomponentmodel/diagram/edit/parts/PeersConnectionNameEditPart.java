 ...
 * @generated
 */
public class PeersConnectionNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				OrocosComponentModelVisualIDRegistry
						.getType(it.unibg.robotics.orocoscomponentmodel.diagram.edit.parts.PeersConnectionNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public PeersConnectionNameEditPart(View view) {
		super(view);
	}
