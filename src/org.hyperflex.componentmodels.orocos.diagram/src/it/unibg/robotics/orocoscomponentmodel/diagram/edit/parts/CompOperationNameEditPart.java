 ...
 * @generated
 */
public class CompOperationNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				OrocosComponentModelVisualIDRegistry
						.getType(it.unibg.robotics.orocoscomponentmodel.diagram.edit.parts.CompOperationNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public CompOperationNameEditPart(View view) {
		super(view);
	}
