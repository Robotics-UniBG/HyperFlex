...
import it.unibg.robotics.orocoscomponentmodel.diagram.edit.policies.CompOperationCaller3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CompOperationCaller3EditPart extends ConnectionNodeEditPart
	 ...
	 * @generated
	 */
	public CompOperationCaller3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CompOperationCaller3ItemSemanticEditPolicy());
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CompOperationCallerNameEditPart) {
			((CompOperationCallerNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureExposeConsumerConnectionLabel());
			return true;
		}
		return false;
	}
