 ...
 * @generated
 */
public class PeersConnectionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PeersConnectionCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof OperationCaller) {
			return false;
		}
		if (target != null && false == target instanceof Operation) {
			return false;
		}
		if (getSource() == null) {
		...
		return OrocosComponentModelBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreatePeersConnection_4007(
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		PeersConnection newElement = it.unibg.robotics.orocoscomponentmodel.orocoscomponentmodelFactory.eINSTANCE
				.createPeersConnection();
		getContainer().getPeersConnections().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(PeersConnection newElement,
	 ...
	 * @generated
	 */
	protected OperationCaller getSource() {
		return (OperationCaller) source;
	}
