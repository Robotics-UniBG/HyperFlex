 ...
 * @generated
 */
public class CompInputPort3CreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CompInputPort3CreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof InputDataPort) {
			return false;
		}
		if (getSource() == null) {
		...
		return OrocosComponentModelBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateCompInputPort_4005(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		CompInputPort newElement = it.unibg.robotics.orocoscomponentmodel.orocoscomponentmodelFactory.eINSTANCE
				.createCompInputPort();
		getSource().getInputPorts().add(newElement);
		newElement.setExposedPort(getTarget());
	 ...
	 * @generated
	 */
	protected void doConfigure(CompInputPort newElement,
	 ...
	 * @generated
	 */
	protected InputDataPort getTarget() {
		return (InputDataPort) target;
	}
