 ...
 * @generated
 */
public class CompOutputPort3CreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CompOutputPort3CreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return OrocosComponentModelBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateCompOutputPort_4004(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		CompOutputPort newElement = it.unibg.robotics.orocoscomponentmodel.orocoscomponentmodelFactory.eINSTANCE
				.createCompOutputPort();
		getSource().getOutputPorts().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(CompOutputPort newElement,
