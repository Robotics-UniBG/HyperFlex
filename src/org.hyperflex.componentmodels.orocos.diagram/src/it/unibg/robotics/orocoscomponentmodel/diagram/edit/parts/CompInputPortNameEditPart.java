 ...
 * @generated
 */
public class CompInputPortNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				OrocosComponentModelVisualIDRegistry
						.getType(it.unibg.robotics.orocoscomponentmodel.diagram.edit.parts.CompInputPortNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public CompInputPortNameEditPart(View view) {
		super(view);
	}
