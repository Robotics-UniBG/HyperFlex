...
import it.unibg.robotics.orocoscomponentmodel.diagram.edit.policies.TCInputDataPortItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TCInputDataPortEditPart extends AbstractBorderItemEditPart {
	 ...
	 * @generated
	 */
	public TCInputDataPortEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TCInputDataPortItemSemanticEditPolicy());
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == OrocosComponentModelElementTypes.CompInputPort_4005) {
