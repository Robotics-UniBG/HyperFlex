...
import it.unibg.robotics.orocoscomponentmodel.diagram.edit.commands.CompositeCreateCommand;
...
public class SystemItemSemanticEditPolicy extends
	...
	public SystemItemSemanticEditPolicy() {
		super(OrocosComponentModelElementTypes.System_1000);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (OrocosComponentModelElementTypes.Composite_2001 == req
				.getElementType()) {
