 ...
 * @generated
 */
public class CompositeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CompositeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OrocosComponentModelParserProvider
					.getParser(
							OrocosComponentModelElementTypes.Composite_2001,
							getParserElement(),
							OrocosComponentModelVisualIDRegistry
									.getType(it.unibg.robotics.orocoscomponentmodel.diagram.edit.parts.CompositeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
