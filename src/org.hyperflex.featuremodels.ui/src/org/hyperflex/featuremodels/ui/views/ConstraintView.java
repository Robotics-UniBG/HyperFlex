package org.hyperflex.featuremodels.ui.views;
...
import org.hyperflex.featuremodels.constraints.utility.ConstraintRuleDialog;
...
public class ConstraintView extends ViewPart implements PropertyChangeListener{
	 ...
	 */
	public static final String ID = "org.hyperflex.featuremodels.ui.views.constraintview";
	...
	public void createPartControl(Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(viewer.getControl(), "org.hyperflex.featureModel.view.ui.viewer");
		makeActions();
		hookContextMenu();
