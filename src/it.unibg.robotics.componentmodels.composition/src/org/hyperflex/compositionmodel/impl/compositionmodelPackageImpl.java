...
public class compositionmodelPackageImpl extends EPackageImpl implements compositionmodelPackage {
	 ...
	 * @generated
	 */
	public EReference getComponentProperty_Properties() {
	...
	public void createPackageContents() {
		...
		createEReference(componentPropertyEClass, COMPONENT_PROPERTY__PROPERTIES);
	...
	public void initializePackageContents() {
		...
		componentPropertyEClass.getESuperTypes().add(this.getProperty());
		...
		initEReference(getComponentProperty_Properties(), this.getComposite(), null, "properties", null, 0, -1, ComponentProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
