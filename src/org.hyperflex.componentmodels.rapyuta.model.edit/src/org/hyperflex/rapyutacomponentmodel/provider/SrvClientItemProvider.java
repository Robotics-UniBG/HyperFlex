...
/**
 * This is the item provider adapter for a {@link org.hyperflex.rapyutacomponentmodel.SrvClient} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SrvClientItemProvider
	 ...
	 * @generated
	 */
	public SrvClientItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addSrvNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SrvClient_srvName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SrvClient_srvName_feature", "_UI_SrvClient_type"),
				 rapyutacomponentmodelPackage.Literals.SRV_CLIENT__SRV_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SrvClient"));
	}
	...
	public String getText(Object object) {
		String label = ((SrvClient)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SrvClient_type") :
			getString("_UI_SrvClient_type") + " " + label;
	}
