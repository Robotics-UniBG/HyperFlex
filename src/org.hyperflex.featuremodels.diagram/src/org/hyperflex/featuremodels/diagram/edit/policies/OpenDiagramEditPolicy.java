...
import org.hyperflex.featuremodels.diagram.part.FeatureModelDiagramEditorUtil;
import org.hyperflex.featuremodels.diagram.part.Messages;
							...
							for (Iterator it = diagramFacet.eResource()
								...
								if (nextResource.isLoaded()
										&& !getEditingDomain().isReadOnly(
												nextResource)) {
									nextResource
											.save(FeatureModelDiagramEditorUtil
													.getSaveOptions());
								}
							}
