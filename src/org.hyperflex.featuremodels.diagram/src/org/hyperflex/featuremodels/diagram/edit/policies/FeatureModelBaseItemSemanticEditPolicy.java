				...
				if (source == null) {
					...
					Map<String, EClassifier> env = Collections
							.<String, EClassifier> singletonMap(
									"oppositeEnd", org.hyperflex.featuremodels.featuremodelsPackage.eINSTANCE.getFeature()); //$NON-NLS-1$
		...
		public boolean canExistContainmentAssociationSubFeatures_4013(
			...
			try {
				...
				if (target == null) {
					...
					Map<String, EClassifier> env = Collections
							.<String, EClassifier> singletonMap(
									"oppositeEnd", org.hyperflex.featuremodels.featuremodelsPackage.eINSTANCE.getContainmentAssociation()); //$NON-NLS-1$
					Object targetVal = FeatureModelOCLFactory
							.getExpression(
									7,
									org.hyperflex.featuremodels.featuremodelsPackage.eINSTANCE
		...
		public boolean canExistFeatureAttributes_4012(Feature source,
			...
			try {
				if (source == null) {
					...
					Map<String, EClassifier> env = Collections
							.<String, EClassifier> singletonMap(
									"oppositeEnd", org.hyperflex.featuremodels.featuremodelsPackage.eINSTANCE.getAttribute()); //$NON-NLS-1$
					Object sourceVal = FeatureModelOCLFactory
							.getExpression(
									10,
									org.hyperflex.featuremodels.featuremodelsPackage.eINSTANCE
