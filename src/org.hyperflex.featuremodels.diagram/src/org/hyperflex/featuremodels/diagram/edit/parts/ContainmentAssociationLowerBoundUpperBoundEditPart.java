...
import org.hyperflex.featuremodels.diagram.edit.policies.FeatureModelTextSelectionEditPolicy;
			...
			parser = FeatureModelParserProvider
					.getParser(
							...
							FeatureModelVisualIDRegistry
									.getType(org.hyperflex.featuremodels.diagram.edit.parts.ContainmentAssociationLowerBoundUpperBoundEditPart.VISUAL_ID));
		}
		return parser;
	}
