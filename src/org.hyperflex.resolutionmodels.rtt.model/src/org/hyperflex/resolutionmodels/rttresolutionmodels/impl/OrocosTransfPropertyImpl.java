...
import org.hyperflex.resolutionmodels.impl.RMTransfPropertyImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Orocos Transf Property</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.hyperflex.resolutionmodels.rttresolutionmodels.impl.OrocosTransfPropertyImpl#getTargetProperty <em>Target Property</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OrocosTransfPropertyImpl extends RMTransfPropertyImpl implements OrocosTransfProperty {
	/**
	 ...
	 * @generated
	 */
	protected OrocosTransfPropertyImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return rttresolutionmodelsPackage.Literals.OROCOS_TRANSF_PROPERTY;
	}
		...
		if (targetProperty != null && targetProperty.eIsProxy()) {
			...
			if (targetProperty != oldTargetProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, rttresolutionmodelsPackage.OROCOS_TRANSF_PROPERTY__TARGET_PROPERTY, oldTargetProperty, targetProperty));
			}
		}
	...
	public void setTargetProperty(Property newTargetProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rttresolutionmodelsPackage.OROCOS_TRANSF_PROPERTY__TARGET_PROPERTY, oldTargetProperty, targetProperty));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case rttresolutionmodelsPackage.OROCOS_TRANSF_PROPERTY__TARGET_PROPERTY:
