...
public class ArchitectureModelImpl extends EObjectImpl implements ArchitectureModel {
	...
	protected EClass eStaticClass() {
		return compositionmodelPackage.Literals.ARCHITECTURE_MODEL;
	}
	...
	public void setSystem(org.hyperflex.compositionmodel.System newSystem) {
		if (newSystem != system) {
			...
			if (system != null)
				msgs = ((InternalEObject)system).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - compositionmodelPackage.ARCHITECTURE_MODEL__SYSTEM, null, msgs);
			if (newSystem != null)
				msgs = ((InternalEObject)newSystem).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - compositionmodelPackage.ARCHITECTURE_MODEL__SYSTEM, null, msgs);
			msgs = basicSetSystem(newSystem, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, compositionmodelPackage.ARCHITECTURE_MODEL__SYSTEM, newSystem, newSystem));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, compositionmodelPackage.ARCHITECTURE_MODEL__NAME, oldName, name));
	}
