 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.roscomponentmodel.impl.AbstractComponentImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AbstractComponentImpl extends EObjectImpl implements AbstractComponent {
	...
	protected EClass eStaticClass() {
		return roscomponentmodelPackage.Literals.ABSTRACT_COMPONENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, roscomponentmodelPackage.ABSTRACT_COMPONENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case roscomponentmodelPackage.ABSTRACT_COMPONENT__NAME:
				return getName();
		}
