...
/**
 * This is the item provider adapter for a {@link it.unibg.robotics.roscomponentmodel.CompositeProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CompositeProperty_exposed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CompositeProperty_exposed_feature", "_UI_CompositeProperty_type"),
				 roscomponentmodelPackage.Literals.COMPOSITE_PROPERTY__EXPOSED,
				 true,
				 false,
				 true,
				 null,
