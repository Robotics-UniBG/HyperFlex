...
/**
 * This is the item provider adapter for a {@link it.unibg.robotics.roscomponentmodel.Node} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NodeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 roscomponentmodelPackage.Literals.NODE__PACKAGE_NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 roscomponentmodelPackage.Literals.NODE__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(roscomponentmodelPackage.Literals.NODE__MSG_PRODUCERS);
			childrenFeatures.add(roscomponentmodelPackage.Literals.NODE__MSG_CONSUMERS);
			childrenFeatures.add(roscomponentmodelPackage.Literals.NODE__PARAMETERS);
			childrenFeatures.add(roscomponentmodelPackage.Literals.NODE__SRV_PRODUCERS);
			childrenFeatures.add(roscomponentmodelPackage.Literals.NODE__SRV_CONSUMERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(roscomponentmodelPackage.Literals.NODE__MSG_PRODUCERS,
				 roscomponentmodelFactory.eINSTANCE.createNodeMsgProducer()));

		newChildDescriptors.add
			(createChildParameter
				(roscomponentmodelPackage.Literals.NODE__MSG_CONSUMERS,
				 roscomponentmodelFactory.eINSTANCE.createNodeMsgConsumer()));
		...
		newChildDescriptors.add
			(createChildParameter
				(roscomponentmodelPackage.Literals.NODE__SRV_PRODUCERS,
				 roscomponentmodelFactory.eINSTANCE.createNodeSrvProducer()));

		newChildDescriptors.add
			(createChildParameter
				(roscomponentmodelPackage.Literals.NODE__SRV_CONSUMERS,
				 roscomponentmodelFactory.eINSTANCE.createNodeSrvConsumer()));
	}
