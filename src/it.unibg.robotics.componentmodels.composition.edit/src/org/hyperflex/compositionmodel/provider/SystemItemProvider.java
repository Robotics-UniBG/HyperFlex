...
public class SystemItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 compositionmodelPackage.Literals.SYSTEM__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(compositionmodelPackage.Literals.SYSTEM__COMPOSITES);
			childrenFeatures.add(compositionmodelPackage.Literals.SYSTEM__PROV_INTERFACES);
			childrenFeatures.add(compositionmodelPackage.Literals.SYSTEM__REQ_INTERFACES);
			childrenFeatures.add(compositionmodelPackage.Literals.SYSTEM__PROPERTIES);
			childrenFeatures.add(compositionmodelPackage.Literals.SYSTEM__CONNECTIONS);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(compositionmodelPackage.Literals.SYSTEM__COMPOSITES,
				 compositionmodelFactory.eINSTANCE.createSystemComposite()));

		newChildDescriptors.add
			(createChildParameter
				(compositionmodelPackage.Literals.SYSTEM__PROV_INTERFACES,
				 compositionmodelFactory.eINSTANCE.createSystemProvidedInterf()));

		newChildDescriptors.add
			(createChildParameter
				(compositionmodelPackage.Literals.SYSTEM__REQ_INTERFACES,
				 compositionmodelFactory.eINSTANCE.createSystemRequiredInterf()));

		newChildDescriptors.add
			(createChildParameter
				(compositionmodelPackage.Literals.SYSTEM__PROPERTIES,
				 compositionmodelFactory.eINSTANCE.createSystemProperty()));

		newChildDescriptors.add
			(createChildParameter
				(compositionmodelPackage.Literals.SYSTEM__CONNECTIONS,
				 compositionmodelFactory.eINSTANCE.createConnection()));
	}
