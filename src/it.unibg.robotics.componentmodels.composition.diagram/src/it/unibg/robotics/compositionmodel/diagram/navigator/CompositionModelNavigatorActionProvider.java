...
import it.unibg.robotics.compositionmodel.diagram.part.CompositionModelDiagramEditor;
 ...
 * @generated
 */
public class CompositionModelNavigatorActionProvider extends
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof CompositionModelNavigatorItem) {
					selectedElement = ((CompositionModelNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (SystemEditPart.MODEL_ID
							.equals(CompositionModelVisualIDRegistry
									.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, CompositionModelDiagramEditor.ID);
