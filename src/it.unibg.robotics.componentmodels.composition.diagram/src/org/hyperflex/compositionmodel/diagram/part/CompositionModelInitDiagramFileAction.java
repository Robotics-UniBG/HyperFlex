 ...
 * @generated
 */
public class CompositionModelInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new CompositionModelNewDiagramFileWizard(
				domainModelURI, diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				SystemEditPart.MODEL_ID));
		CompositionModelDiagramEditorUtil.runWizard(getShell(), wizard,
