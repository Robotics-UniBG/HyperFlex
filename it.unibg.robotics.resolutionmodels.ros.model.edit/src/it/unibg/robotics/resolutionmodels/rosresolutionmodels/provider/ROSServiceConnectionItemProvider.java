...
/**
 * This is the item provider adapter for a {@link it.unibg.robotics.resolutionmodels.rosresolutionmodels.ROSServiceConnection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 rosresolutionmodelsPackage.Literals.ROS_SERVICE_CONNECTION__SERVICE_SERVER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 rosresolutionmodelsPackage.Literals.ROS_SERVICE_CONNECTION__SERVICE_CLIENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 rosresolutionmodelsPackage.Literals.ROS_SERVICE_CONNECTION__SERVICE,
				 true,
				 false,
				 true,
				 null,
