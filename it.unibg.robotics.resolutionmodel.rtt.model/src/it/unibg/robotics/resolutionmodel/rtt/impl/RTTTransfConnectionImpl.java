 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.resolutionmodel.rtt.impl.RTTTransfConnectionImpl#getNewConnections <em>New Connections</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RTTTransfConnectionImpl extends RMTransfConnectionImpl implements RTTTransfConnection {
	...
	protected EClass eStaticClass() {
		return rttPackage.Literals.RTT_TRANSF_CONNECTION;
	}
	...
	public EList<RTTConnection> getNewConnections() {
		if (newConnections == null) {
			newConnections = new EObjectContainmentEList<RTTConnection>(RTTConnection.class, this, rttPackage.RTT_TRANSF_CONNECTION__NEW_CONNECTIONS);
		}
