 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.resolutionmodel.rtt.impl.RTTRequiredConnectionsImpl#getRTTConnectionPolicies <em>RTT Connection Policies</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RTTRequiredConnectionsImpl extends RMRequiredConnectionsImpl implements RTTRequiredConnections {
	...
	protected EClass eStaticClass() {
		return rttPackage.Literals.RTT_REQUIRED_CONNECTIONS;
	}
	...
	public EList<ConnectionPolicy> getRTTConnectionPolicies() {
		if (rttConnectionPolicies == null) {
			rttConnectionPolicies = new EObjectResolvingEList<ConnectionPolicy>(ConnectionPolicy.class, this, rttPackage.RTT_REQUIRED_CONNECTIONS__RTT_CONNECTION_POLICIES);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case rttPackage.RTT_REQUIRED_CONNECTIONS__RTT_CONNECTION_POLICIES:
