 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.resolutionmodel.rtt.impl.RTTRequiredComponentsImpl#getRTTTaskContexts <em>RTT Task Contexts</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RTTRequiredComponentsImpl extends RMRequiredComponentsImpl implements RTTRequiredComponents {
	...
	protected EClass eStaticClass() {
		return rttPackage.Literals.RTT_REQUIRED_COMPONENTS;
	}
	...
	public EList<TaskContext> getRTTTaskContexts() {
		if (rttTaskContexts == null) {
			rttTaskContexts = new EObjectResolvingEList<TaskContext>(TaskContext.class, this, rttPackage.RTT_REQUIRED_COMPONENTS__RTT_TASK_CONTEXTS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case rttPackage.RTT_REQUIRED_COMPONENTS__RTT_TASK_CONTEXTS:
