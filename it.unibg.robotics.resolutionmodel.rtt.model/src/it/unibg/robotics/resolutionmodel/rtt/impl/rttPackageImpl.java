...
public class rttPackageImpl extends EPackageImpl implements rttPackage {
	 ...
	 * @see it.unibg.robotics.resolutionmodel.rtt.rttPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static rttPackage init() {
		if (isInited) return (rttPackage)EPackage.Registry.INSTANCE.getEPackage(rttPackage.eNS_URI);

		// Obtain or create and register package
		rttPackageImpl therttPackage = (rttPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof rttPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new rttPackageImpl());
