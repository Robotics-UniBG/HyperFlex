 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.resolutionmodel.rtt.impl.RTTTransfImplementationImpl#getTargetTaskContext <em>Target Task Context</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RTTTransfImplementationImpl extends RMTransfImplementationImpl implements RTTTransfImplementation {
	...
	protected EClass eStaticClass() {
		return rttPackage.Literals.RTT_TRANSF_IMPLEMENTATION;
	}
		...
		if (targetTaskContext != null && targetTaskContext.eIsProxy()) {
			...
			if (targetTaskContext != oldTargetTaskContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, rttPackage.RTT_TRANSF_IMPLEMENTATION__TARGET_TASK_CONTEXT, oldTargetTaskContext, targetTaskContext));
			}
		}
	...
	public void setTargetTaskContext(TaskContext newTargetTaskContext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rttPackage.RTT_TRANSF_IMPLEMENTATION__TARGET_TASK_CONTEXT, oldTargetTaskContext, targetTaskContext));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case rttPackage.RTT_TRANSF_IMPLEMENTATION__TARGET_TASK_CONTEXT:
