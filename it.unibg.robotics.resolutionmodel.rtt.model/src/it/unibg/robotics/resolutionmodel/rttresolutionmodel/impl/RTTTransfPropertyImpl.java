 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.resolutionmodel.rttresolutionmodel.impl.RTTTransfPropertyImpl#getTargetProperty <em>Target Property</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RTTTransfPropertyImpl extends RMTransfPropertyImpl implements RTTTransfProperty {
	...
	protected EClass eStaticClass() {
		return rttresolutionmodelPackage.Literals.RTT_TRANSF_PROPERTY;
	}
		...
		if (targetProperty != null && targetProperty.eIsProxy()) {
			...
			if (targetProperty != oldTargetProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, rttresolutionmodelPackage.RTT_TRANSF_PROPERTY__TARGET_PROPERTY, oldTargetProperty, targetProperty));
			}
		}
	...
	public void setTargetProperty(Property newTargetProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rttresolutionmodelPackage.RTT_TRANSF_PROPERTY__TARGET_PROPERTY, oldTargetProperty, targetProperty));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case rttresolutionmodelPackage.RTT_TRANSF_PROPERTY__TARGET_PROPERTY:
