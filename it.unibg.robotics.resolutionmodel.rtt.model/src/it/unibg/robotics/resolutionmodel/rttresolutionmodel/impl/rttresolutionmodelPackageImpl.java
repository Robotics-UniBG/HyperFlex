 ...
 * @generated
 */
public class rttresolutionmodelPackageImpl extends EPackageImpl implements rttresolutionmodelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see it.unibg.robotics.resolutionmodel.rttresolutionmodel.rttresolutionmodelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private rttresolutionmodelPackageImpl() {
		super(eNS_URI, rttresolutionmodelFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link rttresolutionmodelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static rttresolutionmodelPackage init() {
		if (isInited) return (rttresolutionmodelPackage)EPackage.Registry.INSTANCE.getEPackage(rttresolutionmodelPackage.eNS_URI);

		// Obtain or create and register package
		rttresolutionmodelPackageImpl therttresolutionmodelPackage = (rttresolutionmodelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof rttresolutionmodelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new rttresolutionmodelPackageImpl());
		...
		therttresolutionmodelPackage.createPackageContents();

		// Initialize created meta-data
		therttresolutionmodelPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		therttresolutionmodelPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(rttresolutionmodelPackage.eNS_URI, therttresolutionmodelPackage);
		return therttresolutionmodelPackage;
	}
	 ...
	 * @generated
	 */
	public rttresolutionmodelFactory getrttresolutionmodelFactory() {
		return (rttresolutionmodelFactory)getEFactoryInstance();
	}
