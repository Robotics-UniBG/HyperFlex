 ...
 * @generated
 */
public class SystemCompositeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SystemCompositeNameEditPart(View view) {
		super(view);
	}
			...
			parser = CompositionModelParserProvider
					.getParser(
							...
							CompositionModelVisualIDRegistry
									.getType(it.unibg.robotics.compositionmodel.diagram.edit.parts.SystemCompositeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					CompositionModelEditPartFactory
