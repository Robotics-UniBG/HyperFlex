...
import it.unibg.robotics.compositionmodel.diagram.edit.policies.SystemCompositeCanonicalEditPolicy;
import it.unibg.robotics.compositionmodel.diagram.edit.policies.SystemCompositeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SystemCompositeEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public SystemCompositeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SystemCompositeItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new SystemCompositeCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SystemCompositeNameEditPart) {
			((SystemCompositeNameEditPart) childEditPart)
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof SystemCompositeProvidedInterfEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((SystemCompositeProvidedInterfEditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof SystemCompositeRequiredInterfEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((SystemCompositeRequiredInterfEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CompositionModelVisualIDRegistry
