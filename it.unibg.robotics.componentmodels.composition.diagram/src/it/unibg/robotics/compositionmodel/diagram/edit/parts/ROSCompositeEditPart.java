...
import it.unibg.robotics.compositionmodel.diagram.edit.policies.ROSCompositeCanonicalEditPolicy;
import it.unibg.robotics.compositionmodel.diagram.edit.policies.ROSCompositeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ROSCompositeEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public ROSCompositeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ROSCompositeItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ROSCompositeCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ROSCompositeNameEditPart) {
			((ROSCompositeNameEditPart) childEditPart)
