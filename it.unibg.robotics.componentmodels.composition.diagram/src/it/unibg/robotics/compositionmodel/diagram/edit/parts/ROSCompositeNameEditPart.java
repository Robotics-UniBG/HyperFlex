 ...
 * @generated
 */
public class ROSCompositeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ROSCompositeNameEditPart(View view) {
		super(view);
	}
			...
			parser = CompositionModelParserProvider
					.getParser(
							...
							CompositionModelVisualIDRegistry
									.getType(it.unibg.robotics.compositionmodel.diagram.edit.parts.ROSCompositeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
