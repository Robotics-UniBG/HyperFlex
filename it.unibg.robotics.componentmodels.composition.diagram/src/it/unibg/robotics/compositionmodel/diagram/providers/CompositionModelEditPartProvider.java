 ...
 * @generated
 */
public class CompositionModelEditPartProvider extends AbstractEditPartProvider {
	...
	public CompositionModelEditPartProvider() {
		setFactory(new CompositionModelEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!SystemEditPart.MODEL_ID
					.equals(CompositionModelVisualIDRegistry.getModelID(view))) {
				return false;
			}
