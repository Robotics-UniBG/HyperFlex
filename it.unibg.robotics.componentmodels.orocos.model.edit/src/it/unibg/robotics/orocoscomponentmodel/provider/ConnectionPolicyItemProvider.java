...
/**
 * This is the item provider adapter for a {@link it.unibg.robotics.orocoscomponentmodel.ConnectionPolicy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 orocoscomponentmodelPackage.Literals.CONNECTION_POLICY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConnectionPolicy_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConnectionPolicy_source_feature", "_UI_ConnectionPolicy_type"),
				 orocoscomponentmodelPackage.Literals.CONNECTION_POLICY__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConnectionPolicy_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConnectionPolicy_target_feature", "_UI_ConnectionPolicy_type"),
				 orocoscomponentmodelPackage.Literals.CONNECTION_POLICY__TARGET,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 orocoscomponentmodelPackage.Literals.CONNECTION_POLICY__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 orocoscomponentmodelPackage.Literals.CONNECTION_POLICY__LOCK_POLICY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 orocoscomponentmodelPackage.Literals.CONNECTION_POLICY__BUFFER_SIZE,
				 true,
				 false,
				 false,
	...
	protected void addTransportPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConnectionPolicy_transport_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConnectionPolicy_transport_feature", "_UI_ConnectionPolicy_type"),
				 orocoscomponentmodelPackage.Literals.CONNECTION_POLICY__TRANSPORT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addNotePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConnectionPolicy_note_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConnectionPolicy_note_feature", "_UI_ConnectionPolicy_type"),
				 orocoscomponentmodelPackage.Literals.CONNECTION_POLICY__NOTE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
