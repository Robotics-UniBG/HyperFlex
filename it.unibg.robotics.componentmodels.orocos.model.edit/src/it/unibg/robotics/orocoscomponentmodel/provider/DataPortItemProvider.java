...
/**
 * This is the item provider adapter for a {@link it.unibg.robotics.orocoscomponentmodel.DataPort} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataPortItemProvider
	 ...
	 * @generated
	 */
	public DataPortItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataPort_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataPort_name_feature", "_UI_DataPort_type"),
				 orocoscomponentmodelPackage.Literals.DATA_PORT__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DataPort.class)) {
			case orocoscomponentmodelPackage.DATA_PORT__NAME:
