...
public abstract class InterfaceImpl extends EObjectImpl implements Interface {
	...
	protected EClass eStaticClass() {
		return compositionmodelPackage.Literals.INTERFACE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, compositionmodelPackage.INTERFACE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case compositionmodelPackage.INTERFACE__NAME:
				return getName();
		}
