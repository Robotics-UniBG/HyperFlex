...
public class featureModelFactoryImpl extends EFactoryImpl implements featureModelFactory {
	...
	public static featureModelFactory init() {
		try {
			featureModelFactory thefeatureModelFactory = (featureModelFactory)EPackage.Registry.INSTANCE.getEFactory("http://robotics.unibg.it/featureModel"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case featureModelPackage.COMPOSITE_FEATURE: return createCompositeFeature();
			...
			case featureModelPackage.INSTANCE: return createInstance();
			case featureModelPackage.SIMPLE_ATTRIBUTE: return createSimpleAttribute();
			default:
