 ...
 * @generated
 */
public abstract class FeatureModelAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = FeatureModelDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected FeatureModelAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
