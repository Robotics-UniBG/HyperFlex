 ...
 * @generated
 */
public class FeatureSubCompositeFeaturesCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public FeatureSubCompositeFeaturesCreateCommand(
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getSubCompositeFeatures().add(getTarget());
