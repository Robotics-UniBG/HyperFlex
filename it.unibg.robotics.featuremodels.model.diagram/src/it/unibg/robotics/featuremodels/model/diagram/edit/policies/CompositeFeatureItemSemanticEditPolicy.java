 ...
 * @generated
 */
public class CompositeFeatureItemSemanticEditPolicy extends
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (FeatureModelVisualIDRegistry.getVisualID(incomingLink) == FeatureSubCompositeFeaturesEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (FeatureModelVisualIDRegistry.getVisualID(outgoingLink) == CompositeFeatureSubFeaturesEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
			...
			if (FeatureModelVisualIDRegistry.getVisualID(outgoingLink) == CompositeFeatureSubFeatures2EditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r) {
