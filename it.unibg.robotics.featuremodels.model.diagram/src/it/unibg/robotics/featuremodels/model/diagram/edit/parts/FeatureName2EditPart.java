...
import it.unibg.robotics.featuremodels.model.diagram.edit.policies.FeatureModelTextSelectionEditPolicy;
...
public class FeatureName2EditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new FeatureModelEditPart.NodeLabelDragPolicy());
	}
			...
			parser = FeatureModelParserProvider
					.getParser(
							...
							FeatureModelVisualIDRegistry
									.getType(it.unibg.robotics.featuremodels.model.diagram.edit.parts.FeatureName2EditPart.VISUAL_ID));
		}
		return parser;
	}
