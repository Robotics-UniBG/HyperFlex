 ...
 * @generated
 */
public class FeatureContainersCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public FeatureContainersCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof ContainmentAssociation) {
			return false;
		}
		if (getSource() == null) {
		...
		return FeatureModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateFeatureContainers_4015(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getContainers().add(getTarget());
	 ...
	 * @generated
	 */
	protected ContainmentAssociation getTarget() {
		return (ContainmentAssociation) target;
	}
}
