 ...
 * @generated
 */
public class CompositeFeatureSubFeatures2CreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public CompositeFeatureSubFeatures2CreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null
				&& false == source instanceof featureModel.CompositeFeature) {
			return false;
		}
		...
		return FeatureModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateCompositeFeatureSubFeatures_4004(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			...
			getTarget().setCompositeParent(getSource());
		}
	 ...
	 * @generated
	 */
	protected featureModel.CompositeFeature getSource() {
		return (featureModel.CompositeFeature) source;
	}
