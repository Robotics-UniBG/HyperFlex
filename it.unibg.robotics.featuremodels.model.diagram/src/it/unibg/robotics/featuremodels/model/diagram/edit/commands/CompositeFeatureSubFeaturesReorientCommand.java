 ...
 * @generated
 */
public class CompositeFeatureSubFeaturesReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public CompositeFeatureSubFeaturesReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return FeatureModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistCompositeFeatureSubFeatures_4003(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return FeatureModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistCompositeFeatureSubFeatures_4003(getOldSource(),
						getNewTarget());
	}
