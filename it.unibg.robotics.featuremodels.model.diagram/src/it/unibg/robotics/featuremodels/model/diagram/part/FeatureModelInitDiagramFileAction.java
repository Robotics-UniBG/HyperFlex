 ...
 * @generated
 */
public class FeatureModelInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new FeatureModelNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				FeatureModelEditPart.MODEL_ID));
		FeatureModelDiagramEditorUtil.runWizard(getShell(), wizard,
