 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.resolutionmodel.impl.ResolutionModelImpl#getName <em>Name</em>}</li>
 *   <li>{@link it.unibg.robotics.resolutionmodel.impl.ResolutionModelImpl#getResolutionElements <em>Resolution Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResolutionModelImpl extends EObjectImpl implements ResolutionModel {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, resolutionmodelPackage.RESOLUTION_MODEL__NAME, oldName, name));
	}
	...
	public EList<RMResolutionElement> getResolutionElements() {
		if (resolutionElements == null) {
			resolutionElements = new EObjectContainmentEList<RMResolutionElement>(RMResolutionElement.class, this, resolutionmodelPackage.RESOLUTION_MODEL__RESOLUTION_ELEMENTS);
		}
