 ...
 * @generated
 */
public class CompositeCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public CompositeCreateCommand(CreateElementRequest req) {
	...
	public boolean canExecute() {
		System container = (System) getElementToEdit();
		if (container.getComposite() != null) {
			return false;
		}
		return true;
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Composite newElement = it.unibg.robotics.orocoscomponentmodel.orocoscomponentmodelFactory.eINSTANCE
				.createComposite();

		System owner = (System) getElementToEdit();
		owner.setComposite(newElement);
