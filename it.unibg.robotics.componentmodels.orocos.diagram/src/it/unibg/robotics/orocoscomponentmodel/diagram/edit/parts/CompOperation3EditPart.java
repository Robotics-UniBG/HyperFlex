...
import it.unibg.robotics.orocoscomponentmodel.diagram.edit.policies.CompOperation3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CompOperation3EditPart extends ConnectionNodeEditPart implements
		ITreeBranchEditPart {
	 ...
	 * @generated
	 */
	public CompOperation3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CompOperation3ItemSemanticEditPolicy());
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CompOperationNameEditPart) {
			((CompOperationNameEditPart) childEditPart)
