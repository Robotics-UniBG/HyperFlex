...
import it.unibg.robotics.orocoscomponentmodel.diagram.edit.policies.PeersConnectionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PeersConnectionEditPart extends ConnectionNodeEditPart implements
		ITreeBranchEditPart {
	 ...
	 * @generated
	 */
	public PeersConnectionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PeersConnectionItemSemanticEditPolicy());
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PeersConnectionNameEditPart) {
			((PeersConnectionNameEditPart) childEditPart)
