	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case CompositeEditPart.VISUAL_ID: {
			...
			OrocosComponentModelNavigatorGroup outgoinglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_Composite_2001_outgoinglinks,
		...
		case TCInputDataPortEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			OrocosComponentModelNavigatorGroup outgoinglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_TCInputDataPort_3002_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			OrocosComponentModelNavigatorGroup incominglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_TCInputDataPort_3002_incominglinks,
		...
		case TCOutputDataPortEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			OrocosComponentModelNavigatorGroup incominglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_TCOutputDataPort_3003_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					OrocosComponentModelVisualIDRegistry
		...
		case Composite2EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			OrocosComponentModelNavigatorGroup outgoinglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_Composite_3005_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					OrocosComponentModelVisualIDRegistry
		...
		case CompInputPortEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			OrocosComponentModelNavigatorGroup outgoinglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompInputPort_3006_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			OrocosComponentModelNavigatorGroup incominglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompInputPort_3006_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					OrocosComponentModelVisualIDRegistry
		...
		case CompOutputPortEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			OrocosComponentModelNavigatorGroup incominglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompOutputPort_3007_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					OrocosComponentModelVisualIDRegistry
		...
		case CompInputPort2EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			OrocosComponentModelNavigatorGroup outgoinglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompInputPort_3008_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			OrocosComponentModelNavigatorGroup incominglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompInputPort_3008_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					OrocosComponentModelVisualIDRegistry
		...
		case CompOutputPort2EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			OrocosComponentModelNavigatorGroup incominglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompOutputPort_3009_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					OrocosComponentModelVisualIDRegistry
		...
		case TCOperationEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			OrocosComponentModelNavigatorGroup incominglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_TCOperation_3010_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					OrocosComponentModelVisualIDRegistry
		...
		case TCOperationCallerEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			OrocosComponentModelNavigatorGroup outgoinglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_TCOperationCaller_3011_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			OrocosComponentModelNavigatorGroup incominglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_TCOperationCaller_3011_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					OrocosComponentModelVisualIDRegistry
		...
		case CompOperationEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			OrocosComponentModelNavigatorGroup incominglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompOperation_3012_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					OrocosComponentModelVisualIDRegistry
		...
		case CompOperationCallerEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			OrocosComponentModelNavigatorGroup outgoinglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompOperationCaller_3013_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			OrocosComponentModelNavigatorGroup incominglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompOperationCaller_3013_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					OrocosComponentModelVisualIDRegistry
		...
		case CompOperation2EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			OrocosComponentModelNavigatorGroup incominglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompOperation_3014_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					OrocosComponentModelVisualIDRegistry
		...
		case CompOperationCaller2EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			OrocosComponentModelNavigatorGroup outgoinglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompOperationCaller_3015_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			OrocosComponentModelNavigatorGroup incominglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompOperationCaller_3015_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					OrocosComponentModelVisualIDRegistry
		...
		case CompOutputPort3EditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			OrocosComponentModelNavigatorGroup target = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompOutputPort_4004_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			OrocosComponentModelNavigatorGroup incominglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompOutputPort_4004_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			OrocosComponentModelNavigatorGroup source = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompOutputPort_4004_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					OrocosComponentModelVisualIDRegistry
		...
		case CompInputPort3EditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			OrocosComponentModelNavigatorGroup target = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompInputPort_4005_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			OrocosComponentModelNavigatorGroup incominglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompInputPort_4005_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			OrocosComponentModelNavigatorGroup source = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompInputPort_4005_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					OrocosComponentModelVisualIDRegistry
		...
		case PeersConnectionEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			OrocosComponentModelNavigatorGroup target = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_PeersConnection_4007_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			OrocosComponentModelNavigatorGroup source = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_PeersConnection_4007_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					OrocosComponentModelVisualIDRegistry
		...
		case CompOperation3EditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			OrocosComponentModelNavigatorGroup target = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompOperation_4008_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			OrocosComponentModelNavigatorGroup incominglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompOperation_4008_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			OrocosComponentModelNavigatorGroup source = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompOperation_4008_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					OrocosComponentModelVisualIDRegistry
		...
		case CompOperationCaller3EditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			OrocosComponentModelNavigatorGroup target = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompOperationCaller_4009_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			OrocosComponentModelNavigatorGroup incominglinks = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompOperationCaller_4009_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			OrocosComponentModelNavigatorGroup source = new OrocosComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_CompOperationCaller_4009_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					OrocosComponentModelVisualIDRegistry
