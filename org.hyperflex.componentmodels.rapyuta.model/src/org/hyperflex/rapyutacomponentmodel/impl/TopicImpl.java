...
public class TopicImpl extends EObjectImpl implements Topic {
	...
	protected EClass eStaticClass() {
		return rapyutacomponentmodelPackage.Literals.TOPIC;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rapyutacomponentmodelPackage.TOPIC__NAME, oldName, name));
	}
