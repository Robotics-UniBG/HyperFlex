...
import it.unibg.robotics.resolutionmodels.impl.RMTransfConnectionImpl;
 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.resolutionmodels.rosresolutionmodels.impl.ROSTransfConnectionImpl#getNewConnections <em>New Connections</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ROSTransfConnectionImpl extends RMTransfConnectionImpl implements ROSTransfConnection {
	...
	public EList<ROSAbstractConnection> getNewConnections() {
		if (newConnections == null) {
			newConnections = new EObjectContainmentEList<ROSAbstractConnection>(ROSAbstractConnection.class, this, rosresolutionmodelsPackage.ROS_TRANSF_CONNECTION__NEW_CONNECTIONS);
		}
