...
import it.unibg.robotics.resolutionmodels.impl.RMRequiredComponentsImpl;
 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.resolutionmodels.rosresolutionmodels.impl.ROSRequiredComponentsImpl#getROSNodes <em>ROS Nodes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ROSRequiredComponentsImpl extends RMRequiredComponentsImpl implements ROSRequiredComponents {
	...
	protected EClass eStaticClass() {
		return rosresolutionmodelsPackage.Literals.ROS_REQUIRED_COMPONENTS;
	}
	...
	public EList<Node> getROSNodes() {
		if (rosNodes == null) {
			rosNodes = new EObjectResolvingEList<Node>(Node.class, this, rosresolutionmodelsPackage.ROS_REQUIRED_COMPONENTS__ROS_NODES);
		}
		return rosNodes;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case rosresolutionmodelsPackage.ROS_REQUIRED_COMPONENTS__ROS_NODES:
				return getROSNodes();
		}
