 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.resolutionmodels.rosresolutionmodels.impl.ROSNewActionConnectionImpl#getActionServer <em>Action Server</em>}</li>
 *   <li>{@link it.unibg.robotics.resolutionmodels.rosresolutionmodels.impl.ROSNewActionConnectionImpl#getActionClient <em>Action Client</em>}</li>
...
public class ROSNewActionConnectionImpl extends ROSAbstractConnectionImpl implements ROSNewActionConnection {
		...
		if (actionServer != null && actionServer.eIsProxy()) {
			...
			if (actionServer != oldActionServer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, rosresolutionmodelsPackage.ROS_NEW_ACTION_CONNECTION__ACTION_SERVER, oldActionServer, actionServer));
			}
		}
		return actionServer;
	}
	...
	public void setActionServer(ActionServer newActionServer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rosresolutionmodelsPackage.ROS_NEW_ACTION_CONNECTION__ACTION_SERVER, oldActionServer, actionServer));
	}
	...
	public ActionClient getActionClient() {
		if (actionClient != null && actionClient.eIsProxy()) {
			...
			if (actionClient != oldActionClient) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, rosresolutionmodelsPackage.ROS_NEW_ACTION_CONNECTION__ACTION_CLIENT, oldActionClient, actionClient));
			}
		}
		return actionClient;
	}
	...
	public void setActionClient(ActionClient newActionClient) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rosresolutionmodelsPackage.ROS_NEW_ACTION_CONNECTION__ACTION_CLIENT, oldActionClient, actionClient));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case rosresolutionmodelsPackage.ROS_NEW_ACTION_CONNECTION__ACTION_SERVER:
				if (resolve) return getActionServer();
				return basicGetActionServer();
			case rosresolutionmodelsPackage.ROS_NEW_ACTION_CONNECTION__ACTION_CLIENT:
