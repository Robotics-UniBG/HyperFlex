...
import org.hyperflex.rapyutacomponentmodel.diagram.part.RapyutaComponentModelDiagramEditor;
 ...
 * @generated
 */
public class RapyutaComponentModelNavigatorActionProvider extends
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof RapyutaComponentModelNavigatorItem) {
					selectedElement = ((RapyutaComponentModelNavigatorItem) selectedElement)
							.getView();
