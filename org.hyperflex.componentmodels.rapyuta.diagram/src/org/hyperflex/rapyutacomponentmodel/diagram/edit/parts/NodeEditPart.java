...
import org.hyperflex.rapyutacomponentmodel.diagram.edit.policies.NodeCanonicalEditPolicy;
import org.hyperflex.rapyutacomponentmodel.diagram.edit.policies.NodeItemSemanticEditPolicy;
...
public class NodeEditPart extends AbstractBorderedShapeEditPart {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == RapyutaComponentModelElementTypes.NodeParameter_3002) {
				return getChildBySemanticHint(RapyutaComponentModelVisualIDRegistry
