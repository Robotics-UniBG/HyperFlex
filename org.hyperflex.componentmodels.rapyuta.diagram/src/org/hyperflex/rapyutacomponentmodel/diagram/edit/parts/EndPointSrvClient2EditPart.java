...
import org.hyperflex.rapyutacomponentmodel.diagram.edit.policies.EndPointSrvClient2ItemSemanticEditPolicy;
import org.hyperflex.rapyutacomponentmodel.diagram.providers.RapyutaComponentModelElementTypes;

/**
 * @generated
 */
public class EndPointSrvClient2EditPart extends AbstractBorderItemEditPart {
	 ...
	 * @generated
	 */
	public EndPointSrvClient2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EndPointSrvClient2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new Consumer2Figure();
	}

	/**
	 * @generated
	 */
	public Consumer2Figure getPrimaryShape() {
		return (Consumer2Figure) primaryShape;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == RapyutaComponentModelElementTypes.EndPointSrvConnection_4006) {
		...
		} else if (relationshipType == RapyutaComponentModelElementTypes.CompositeSrvConnection_4010) {
	 ...
	 * @generated
	 */
	public class Consumer2Figure extends RectangleFigure {

		/**
		 * @generated
		 */
		public Consumer2Figure() {
