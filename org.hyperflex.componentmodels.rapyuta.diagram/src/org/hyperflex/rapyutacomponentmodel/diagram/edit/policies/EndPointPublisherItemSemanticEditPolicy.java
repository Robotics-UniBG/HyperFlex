 ...
 * @generated
 */
public class EndPointPublisherItemSemanticEditPolicy extends
		RapyutaComponentModelBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public EndPointPublisherItemSemanticEditPolicy() {
		super(RapyutaComponentModelElementTypes.EndPointPublisher_3019);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (RapyutaComponentModelVisualIDRegistry.getVisualID(outgoingLink) == EndPointMsgConnectionEditPart.VISUAL_ID) {
