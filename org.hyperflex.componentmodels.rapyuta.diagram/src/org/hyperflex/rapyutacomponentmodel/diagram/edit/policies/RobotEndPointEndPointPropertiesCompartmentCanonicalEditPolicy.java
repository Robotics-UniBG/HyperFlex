 ...
 * @generated
 */
public class RobotEndPointEndPointPropertiesCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<RapyutaComponentModelNodeDescriptor> childDescriptors = RapyutaComponentModelDiagramUpdater
				.getRobotEndPointEndPointPropertiesCompartment_7009SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return EndPointParameterEditPart.VISUAL_ID == RapyutaComponentModelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<RapyutaComponentModelNodeDescriptor> childDescriptors = RapyutaComponentModelDiagramUpdater
				.getRobotEndPointEndPointPropertiesCompartment_7009SemanticChildren((View) getHost()
						.getModel());
