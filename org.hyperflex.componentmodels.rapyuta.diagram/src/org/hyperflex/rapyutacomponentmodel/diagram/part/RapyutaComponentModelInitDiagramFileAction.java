 ...
 * @generated
 */
public class RapyutaComponentModelInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new RapyutaComponentModelNewDiagramFileWizard(
				domainModelURI, diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				SystemEditPart.MODEL_ID));
		RapyutaComponentModelDiagramEditorUtil.runWizard(getShell(), wizard,
