 ...
 * @generated
 */
public abstract class RapyutaComponentModelAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = RapyutaComponentModelDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected RapyutaComponentModelAbstractExpression(String body,
			EClassifier context) {
		myBody = body;
		myContext = context;
	}
