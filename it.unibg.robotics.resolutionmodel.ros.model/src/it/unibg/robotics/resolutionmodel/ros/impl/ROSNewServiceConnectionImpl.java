 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.resolutionmodel.ros.impl.ROSNewServiceConnectionImpl#getServiceServer <em>Service Server</em>}</li>
 *   <li>{@link it.unibg.robotics.resolutionmodel.ros.impl.ROSNewServiceConnectionImpl#getServiceClient <em>Service Client</em>}</li>
 *   <li>{@link it.unibg.robotics.resolutionmodel.ros.impl.ROSNewServiceConnectionImpl#getServiceName <em>Service Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ROSNewServiceConnectionImpl extends ROSAbstractConnectionImpl implements ROSNewServiceConnection {
	...
	protected EClass eStaticClass() {
		return rosPackage.Literals.ROS_NEW_SERVICE_CONNECTION;
	}
		...
		if (serviceServer != null && serviceServer.eIsProxy()) {
			...
			if (serviceServer != oldServiceServer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, rosPackage.ROS_NEW_SERVICE_CONNECTION__SERVICE_SERVER, oldServiceServer, serviceServer));
			}
		}
	...
	public void setServiceServer(ServiceServer newServiceServer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rosPackage.ROS_NEW_SERVICE_CONNECTION__SERVICE_SERVER, oldServiceServer, serviceServer));
	}
	...
	public ServiceClient getServiceClient() {
		if (serviceClient != null && serviceClient.eIsProxy()) {
			...
			if (serviceClient != oldServiceClient) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, rosPackage.ROS_NEW_SERVICE_CONNECTION__SERVICE_CLIENT, oldServiceClient, serviceClient));
			}
		}
	...
	public void setServiceClient(ServiceClient newServiceClient) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rosPackage.ROS_NEW_SERVICE_CONNECTION__SERVICE_CLIENT, oldServiceClient, serviceClient));
	}
	...
	public void setServiceName(String newServiceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rosPackage.ROS_NEW_SERVICE_CONNECTION__SERVICE_NAME, oldServiceName, serviceName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case rosPackage.ROS_NEW_SERVICE_CONNECTION__SERVICE_SERVER:
				if (resolve) return getServiceServer();
				return basicGetServiceServer();
			case rosPackage.ROS_NEW_SERVICE_CONNECTION__SERVICE_CLIENT:
