 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.resolutionmodel.ros.impl.ROSRequiredComponentsImpl#getROSNodes <em>ROS Nodes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ROSRequiredComponentsImpl extends RMRequiredComponentsImpl implements ROSRequiredComponents {
	...
	protected EClass eStaticClass() {
		return rosPackage.Literals.ROS_REQUIRED_COMPONENTS;
	}
	...
	public EList<Node> getROSNodes() {
		if (rosNodes == null) {
			rosNodes = new EObjectResolvingEList<Node>(Node.class, this, rosPackage.ROS_REQUIRED_COMPONENTS__ROS_NODES);
		}
		return rosNodes;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case rosPackage.ROS_REQUIRED_COMPONENTS__ROS_NODES:
				return getROSNodes();
		}
