 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.resolutionmodel.ros.impl.ROSTransfImplementationImpl#getTargetNode <em>Target Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ROSTransfImplementationImpl extends RMTransfImplementationImpl implements ROSTransfImplementation {
	...
	protected EClass eStaticClass() {
		return rosPackage.Literals.ROS_TRANSF_IMPLEMENTATION;
	}
		...
		if (targetNode != null && targetNode.eIsProxy()) {
			...
			if (targetNode != oldTargetNode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, rosPackage.ROS_TRANSF_IMPLEMENTATION__TARGET_NODE, oldTargetNode, targetNode));
			}
		}
		return targetNode;
	}
	...
	public void setTargetNode(Node newTargetNode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rosPackage.ROS_TRANSF_IMPLEMENTATION__TARGET_NODE, oldTargetNode, targetNode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case rosPackage.ROS_TRANSF_IMPLEMENTATION__TARGET_NODE:
