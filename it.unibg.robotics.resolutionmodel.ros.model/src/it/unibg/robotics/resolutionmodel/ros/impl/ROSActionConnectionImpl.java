 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.resolutionmodel.ros.impl.ROSActionConnectionImpl#getActionServer <em>Action Server</em>}</li>
 *   <li>{@link it.unibg.robotics.resolutionmodel.ros.impl.ROSActionConnectionImpl#getActionClient <em>Action Client</em>}</li>
 *   <li>{@link it.unibg.robotics.resolutionmodel.ros.impl.ROSActionConnectionImpl#getAction <em>Action</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ROSActionConnectionImpl extends ROSAbstractConnectionImpl implements ROSActionConnection {
	...
	protected EClass eStaticClass() {
		return rosPackage.Literals.ROS_ACTION_CONNECTION;
	}
		...
		if (actionServer != null && actionServer.eIsProxy()) {
			...
			if (actionServer != oldActionServer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, rosPackage.ROS_ACTION_CONNECTION__ACTION_SERVER, oldActionServer, actionServer));
			}
		}
		return actionServer;
	}
	...
	public void setActionServer(ActionServer newActionServer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rosPackage.ROS_ACTION_CONNECTION__ACTION_SERVER, oldActionServer, actionServer));
	}
	...
	public ActionClient getActionClient() {
		if (actionClient != null && actionClient.eIsProxy()) {
			...
			if (actionClient != oldActionClient) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, rosPackage.ROS_ACTION_CONNECTION__ACTION_CLIENT, oldActionClient, actionClient));
			}
		}
		return actionClient;
	}
	...
	public void setActionClient(ActionClient newActionClient) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rosPackage.ROS_ACTION_CONNECTION__ACTION_CLIENT, oldActionClient, actionClient));
	}
	...
	public Action getAction() {
		if (action != null && action.eIsProxy()) {
			...
			if (action != oldAction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, rosPackage.ROS_ACTION_CONNECTION__ACTION, oldAction, action));
			}
		}
		return action;
	}
	...
	public void setAction(Action newAction) {
		...
		action = newAction;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rosPackage.ROS_ACTION_CONNECTION__ACTION, oldAction, action));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case rosPackage.ROS_ACTION_CONNECTION__ACTION_SERVER:
				if (resolve) return getActionServer();
				return basicGetActionServer();
			case rosPackage.ROS_ACTION_CONNECTION__ACTION_CLIENT:
				if (resolve) return getActionClient();
				return basicGetActionClient();
			case rosPackage.ROS_ACTION_CONNECTION__ACTION:
