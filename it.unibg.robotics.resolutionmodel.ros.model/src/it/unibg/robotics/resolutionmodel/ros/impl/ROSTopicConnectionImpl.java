 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.resolutionmodel.ros.impl.ROSTopicConnectionImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link it.unibg.robotics.resolutionmodel.ros.impl.ROSTopicConnectionImpl#getSubscriber <em>Subscriber</em>}</li>
 *   <li>{@link it.unibg.robotics.resolutionmodel.ros.impl.ROSTopicConnectionImpl#getTopic <em>Topic</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ROSTopicConnectionImpl extends ROSAbstractConnectionImpl implements ROSTopicConnection {
	...
	protected EClass eStaticClass() {
		return rosPackage.Literals.ROS_TOPIC_CONNECTION;
	}
		...
		if (publisher != null && publisher.eIsProxy()) {
			...
			if (publisher != oldPublisher) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, rosPackage.ROS_TOPIC_CONNECTION__PUBLISHER, oldPublisher, publisher));
			}
		}
		return publisher;
	}
	...
	public void setPublisher(Publisher newPublisher) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rosPackage.ROS_TOPIC_CONNECTION__PUBLISHER, oldPublisher, publisher));
	}
	...
	public Subscriber getSubscriber() {
		if (subscriber != null && subscriber.eIsProxy()) {
			...
			if (subscriber != oldSubscriber) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, rosPackage.ROS_TOPIC_CONNECTION__SUBSCRIBER, oldSubscriber, subscriber));
			}
		}
		return subscriber;
	}
	...
	public void setSubscriber(Subscriber newSubscriber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rosPackage.ROS_TOPIC_CONNECTION__SUBSCRIBER, oldSubscriber, subscriber));
	}
	...
	public Topic getTopic() {
		if (topic != null && topic.eIsProxy()) {
			...
			if (topic != oldTopic) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, rosPackage.ROS_TOPIC_CONNECTION__TOPIC, oldTopic, topic));
			}
		}
		return topic;
	}
	...
	public void setTopic(Topic newTopic) {
		...
		topic = newTopic;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rosPackage.ROS_TOPIC_CONNECTION__TOPIC, oldTopic, topic));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case rosPackage.ROS_TOPIC_CONNECTION__PUBLISHER:
				if (resolve) return getPublisher();
				return basicGetPublisher();
			case rosPackage.ROS_TOPIC_CONNECTION__SUBSCRIBER:
				if (resolve) return getSubscriber();
				return basicGetSubscriber();
			case rosPackage.ROS_TOPIC_CONNECTION__TOPIC:
