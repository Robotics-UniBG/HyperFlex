 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.resolutionmodel.rosresolutionmodel.impl.ROSNewActionConnectionImpl#getActionServer <em>Action Server</em>}</li>
 *   <li>{@link it.unibg.robotics.resolutionmodel.rosresolutionmodel.impl.ROSNewActionConnectionImpl#getActionClient <em>Action Client</em>}</li>
 *   <li>{@link it.unibg.robotics.resolutionmodel.rosresolutionmodel.impl.ROSNewActionConnectionImpl#getActionName <em>Action Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ROSNewActionConnectionImpl extends ROSAbstractConnectionImpl implements ROSNewActionConnection {
	...
	protected EClass eStaticClass() {
		return rosresolutionmodelPackage.Literals.ROS_NEW_ACTION_CONNECTION;
	}
		...
		if (actionServer != null && actionServer.eIsProxy()) {
			...
			if (actionServer != oldActionServer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, rosresolutionmodelPackage.ROS_NEW_ACTION_CONNECTION__ACTION_SERVER, oldActionServer, actionServer));
			}
		}
		return actionServer;
	}
	...
	public void setActionServer(ActionServer newActionServer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rosresolutionmodelPackage.ROS_NEW_ACTION_CONNECTION__ACTION_SERVER, oldActionServer, actionServer));
	}
	...
	public ActionClient getActionClient() {
		if (actionClient != null && actionClient.eIsProxy()) {
			...
			if (actionClient != oldActionClient) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, rosresolutionmodelPackage.ROS_NEW_ACTION_CONNECTION__ACTION_CLIENT, oldActionClient, actionClient));
			}
		}
		return actionClient;
	}
	...
	public void setActionClient(ActionClient newActionClient) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rosresolutionmodelPackage.ROS_NEW_ACTION_CONNECTION__ACTION_CLIENT, oldActionClient, actionClient));
	}
	...
	public void setActionName(String newActionName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rosresolutionmodelPackage.ROS_NEW_ACTION_CONNECTION__ACTION_NAME, oldActionName, actionName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case rosresolutionmodelPackage.ROS_NEW_ACTION_CONNECTION__ACTION_SERVER:
				if (resolve) return getActionServer();
				return basicGetActionServer();
			case rosresolutionmodelPackage.ROS_NEW_ACTION_CONNECTION__ACTION_CLIENT:
				if (resolve) return getActionClient();
				return basicGetActionClient();
			case rosresolutionmodelPackage.ROS_NEW_ACTION_CONNECTION__ACTION_NAME:
