 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.resolutionmodel.rosresolutionmodel.impl.ROSTransfPropertyImpl#getTargetProperty <em>Target Property</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ROSTransfPropertyImpl extends RMTransfPropertyImpl implements ROSTransfProperty {
	...
	protected EClass eStaticClass() {
		return rosresolutionmodelPackage.Literals.ROS_TRANSF_PROPERTY;
	}
		...
		if (targetProperty != null && targetProperty.eIsProxy()) {
			...
			if (targetProperty != oldTargetProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, rosresolutionmodelPackage.ROS_TRANSF_PROPERTY__TARGET_PROPERTY, oldTargetProperty, targetProperty));
			}
		}
	...
	public void setTargetProperty(Parameter newTargetProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, rosresolutionmodelPackage.ROS_TRANSF_PROPERTY__TARGET_PROPERTY, oldTargetProperty, targetProperty));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case rosresolutionmodelPackage.ROS_TRANSF_PROPERTY__TARGET_PROPERTY:
