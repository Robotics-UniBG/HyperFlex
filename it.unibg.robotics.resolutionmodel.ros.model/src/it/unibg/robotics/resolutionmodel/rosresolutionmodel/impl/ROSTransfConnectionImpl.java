 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.resolutionmodel.rosresolutionmodel.impl.ROSTransfConnectionImpl#getNewConnections <em>New Connections</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ROSTransfConnectionImpl extends RMTransfConnectionImpl implements ROSTransfConnection {
	...
	protected EClass eStaticClass() {
		return rosresolutionmodelPackage.Literals.ROS_TRANSF_CONNECTION;
	}
	...
	public EList<ROSAbstractConnection> getNewConnections() {
		if (newConnections == null) {
			newConnections = new EObjectContainmentEList<ROSAbstractConnection>(ROSAbstractConnection.class, this, rosresolutionmodelPackage.ROS_TRANSF_CONNECTION__NEW_CONNECTIONS);
		}
