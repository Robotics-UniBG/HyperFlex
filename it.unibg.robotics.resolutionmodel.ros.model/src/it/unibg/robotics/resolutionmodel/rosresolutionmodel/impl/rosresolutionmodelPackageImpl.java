 ...
 * @generated
 */
public class rosresolutionmodelPackageImpl extends EPackageImpl implements rosresolutionmodelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see it.unibg.robotics.resolutionmodel.rosresolutionmodel.rosresolutionmodelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private rosresolutionmodelPackageImpl() {
		super(eNS_URI, rosresolutionmodelFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link rosresolutionmodelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static rosresolutionmodelPackage init() {
		if (isInited) return (rosresolutionmodelPackage)EPackage.Registry.INSTANCE.getEPackage(rosresolutionmodelPackage.eNS_URI);

		// Obtain or create and register package
		rosresolutionmodelPackageImpl therosresolutionmodelPackage = (rosresolutionmodelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof rosresolutionmodelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new rosresolutionmodelPackageImpl());
		...
		therosresolutionmodelPackage.createPackageContents();

		// Initialize created meta-data
		therosresolutionmodelPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		therosresolutionmodelPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(rosresolutionmodelPackage.eNS_URI, therosresolutionmodelPackage);
		return therosresolutionmodelPackage;
	}
	 ...
	 * @generated
	 */
	public rosresolutionmodelFactory getrosresolutionmodelFactory() {
		return (rosresolutionmodelFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		resolutionmodelPackage theresolutionmodelPackage = (resolutionmodelPackage)EPackage.Registry.INSTANCE.getEPackage(resolutionmodelPackage.eNS_URI);
		...
		rosTransfImplementationEClass.getESuperTypes().add(theresolutionmodelPackage.getRMTransfImplementation());
		rosTransfPropertyEClass.getESuperTypes().add(theresolutionmodelPackage.getRMTransfProperty());
		rosTransfConnectionEClass.getESuperTypes().add(theresolutionmodelPackage.getRMTransfConnection());
		...
		rosRequiredComponentsEClass.getESuperTypes().add(theresolutionmodelPackage.getRMRequiredComponents());
		rosRequiredConnectionsEClass.getESuperTypes().add(theresolutionmodelPackage.getRMRequiredConnections());
