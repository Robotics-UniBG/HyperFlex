 ...
 * @generated
 */
public class rosresolutionmodelSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public rosresolutionmodelSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case rosresolutionmodelPackage.ROS_TRANSF_IMPLEMENTATION: {
			...
			case rosresolutionmodelPackage.ROS_TRANSF_PROPERTY: {
			...
			case rosresolutionmodelPackage.ROS_TRANSF_CONNECTION: {
			...
			case rosresolutionmodelPackage.ROS_ABSTRACT_CONNECTION: {
			...
			case rosresolutionmodelPackage.ROS_TOPIC_CONNECTION: {
			...
			case rosresolutionmodelPackage.ROS_NEW_TOPIC_CONNECTION: {
			...
			case rosresolutionmodelPackage.ROS_SERVICE_CONNECTION: {
			...
			case rosresolutionmodelPackage.ROS_NEW_SERVICE_CONNECTION: {
			...
			case rosresolutionmodelPackage.ROS_ACTION_CONNECTION: {
			...
			case rosresolutionmodelPackage.ROS_NEW_ACTION_CONNECTION: {
			...
			case rosresolutionmodelPackage.ROS_REQUIRED_COMPONENTS: {
			...
			case rosresolutionmodelPackage.ROS_REQUIRED_CONNECTIONS: {
