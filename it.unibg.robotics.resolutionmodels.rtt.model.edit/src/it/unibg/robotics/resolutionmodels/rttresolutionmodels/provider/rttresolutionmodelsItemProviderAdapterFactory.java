				...
				newChildDescriptors.add
					(createChildParameter
						(resolutionmodelsPackage.Literals.RM_RESOLUTION_ELEMENT__TRANSFORMATIONS,
						 rttresolutionmodelsFactory.eINSTANCE.createRTTTransfImplementation()));

				newChildDescriptors.add
					(createChildParameter
						(resolutionmodelsPackage.Literals.RM_RESOLUTION_ELEMENT__TRANSFORMATIONS,
						 rttresolutionmodelsFactory.eINSTANCE.createRTTTransfProperty()));

				newChildDescriptors.add
					(createChildParameter
						(resolutionmodelsPackage.Literals.RM_RESOLUTION_ELEMENT__TRANSFORMATIONS,
						 rttresolutionmodelsFactory.eINSTANCE.createRTTTransfConnection()));

				newChildDescriptors.add
					(createChildParameter
						(resolutionmodelsPackage.Literals.RM_RESOLUTION_ELEMENT__REQUIRED_COMPONENTS,
						 rttresolutionmodelsFactory.eINSTANCE.createRTTRequiredComponents()));

				newChildDescriptors.add
					(createChildParameter
						(resolutionmodelsPackage.Literals.RM_RESOLUTION_ELEMENT__REQUIRED_CONNECTIONS,
						 rttresolutionmodelsFactory.eINSTANCE.createRTTRequiredConnections()));
