...
/**
 * This is the item provider adapter for a {@link it.unibg.robotics.resolutionmodel.ros.ROSTransfConnection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ROSTransfConnectionItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(rosPackage.Literals.ROS_TRANSF_CONNECTION__NEW_CONNECTIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(rosPackage.Literals.ROS_TRANSF_CONNECTION__NEW_CONNECTIONS,
				 rosFactory.eINSTANCE.createROSTopicConnection()));

		newChildDescriptors.add
			(createChildParameter
				(rosPackage.Literals.ROS_TRANSF_CONNECTION__NEW_CONNECTIONS,
				 rosFactory.eINSTANCE.createROSNewTopicConnection()));
		...
		newChildDescriptors.add
			(createChildParameter
				(rosPackage.Literals.ROS_TRANSF_CONNECTION__NEW_CONNECTIONS,
				 rosFactory.eINSTANCE.createROSNewServiceConnection()));
		...
		newChildDescriptors.add
			(createChildParameter
				(rosPackage.Literals.ROS_TRANSF_CONNECTION__NEW_CONNECTIONS,
				 rosFactory.eINSTANCE.createROSNewActionConnection()));
	}
