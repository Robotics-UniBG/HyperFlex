...
/**
 * This is the item provider adapter for a {@link it.unibg.robotics.resolutionmodel.ros.ROSTopicConnection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 rosPackage.Literals.ROS_TOPIC_CONNECTION__PUBLISHER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 rosPackage.Literals.ROS_TOPIC_CONNECTION__SUBSCRIBER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 rosPackage.Literals.ROS_TOPIC_CONNECTION__TOPIC,
				 true,
				 false,
				 true,
				 null,
