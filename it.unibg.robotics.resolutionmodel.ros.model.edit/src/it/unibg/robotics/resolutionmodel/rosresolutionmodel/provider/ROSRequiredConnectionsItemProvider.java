...
/**
 * This is the item provider adapter for a {@link it.unibg.robotics.resolutionmodel.rosresolutionmodel.ROSRequiredConnections} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ROSRequiredConnectionsItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 rosresolutionmodelPackage.Literals.ROS_REQUIRED_CONNECTIONS__REQUIRED_TOPIC_CONNECTIONS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 rosresolutionmodelPackage.Literals.ROS_REQUIRED_CONNECTIONS__REQUIRED_SERVICE_CONNECTIONS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 rosresolutionmodelPackage.Literals.ROS_REQUIRED_CONNECTIONS__REQUIRED_ACTION_CONNECTIONS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(rosresolutionmodelPackage.Literals.ROS_REQUIRED_CONNECTIONS__REQUIRED_TOPIC_CONNECTIONS);
			childrenFeatures.add(rosresolutionmodelPackage.Literals.ROS_REQUIRED_CONNECTIONS__REQUIRED_SERVICE_CONNECTIONS);
			childrenFeatures.add(rosresolutionmodelPackage.Literals.ROS_REQUIRED_CONNECTIONS__REQUIRED_ACTION_CONNECTIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(rosresolutionmodelPackage.Literals.ROS_REQUIRED_CONNECTIONS__REQUIRED_TOPIC_CONNECTIONS,
				 rosresolutionmodelFactory.eINSTANCE.createROSTopicConnection()));

		newChildDescriptors.add
			(createChildParameter
				(rosresolutionmodelPackage.Literals.ROS_REQUIRED_CONNECTIONS__REQUIRED_SERVICE_CONNECTIONS,
				 rosresolutionmodelFactory.eINSTANCE.createROSServiceConnection()));

		newChildDescriptors.add
			(createChildParameter
				(rosresolutionmodelPackage.Literals.ROS_REQUIRED_CONNECTIONS__REQUIRED_ACTION_CONNECTIONS,
				 rosresolutionmodelFactory.eINSTANCE.createROSActionConnection()));
	}
