...
/**
 * This is the item provider adapter for a {@link it.unibg.robotics.resolutionmodel.rosresolutionmodel.ROSNewServiceConnection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 rosresolutionmodelPackage.Literals.ROS_NEW_SERVICE_CONNECTION__SERVICE_SERVER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 rosresolutionmodelPackage.Literals.ROS_NEW_SERVICE_CONNECTION__SERVICE_CLIENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 rosresolutionmodelPackage.Literals.ROS_NEW_SERVICE_CONNECTION__SERVICE_NAME,
				 true,
				 false,
				 false,
