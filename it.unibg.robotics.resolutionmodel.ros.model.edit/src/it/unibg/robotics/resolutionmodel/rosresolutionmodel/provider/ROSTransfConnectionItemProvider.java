...
/**
 * This is the item provider adapter for a {@link it.unibg.robotics.resolutionmodel.rosresolutionmodel.ROSTransfConnection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ROSTransfConnectionItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(rosresolutionmodelPackage.Literals.ROS_TRANSF_CONNECTION__NEW_CONNECTIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ROSTransfConnection.class)) {
			case rosresolutionmodelPackage.ROS_TRANSF_CONNECTION__NEW_CONNECTIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(rosresolutionmodelPackage.Literals.ROS_TRANSF_CONNECTION__NEW_CONNECTIONS,
				 rosresolutionmodelFactory.eINSTANCE.createROSTopicConnection()));

		newChildDescriptors.add
			(createChildParameter
				(rosresolutionmodelPackage.Literals.ROS_TRANSF_CONNECTION__NEW_CONNECTIONS,
				 rosresolutionmodelFactory.eINSTANCE.createROSNewTopicConnection()));
		...
		newChildDescriptors.add
			(createChildParameter
				(rosresolutionmodelPackage.Literals.ROS_TRANSF_CONNECTION__NEW_CONNECTIONS,
				 rosresolutionmodelFactory.eINSTANCE.createROSNewServiceConnection()));
		...
		newChildDescriptors.add
			(createChildParameter
				(rosresolutionmodelPackage.Literals.ROS_TRANSF_CONNECTION__NEW_CONNECTIONS,
				 rosresolutionmodelFactory.eINSTANCE.createROSNewActionConnection()));
	}
