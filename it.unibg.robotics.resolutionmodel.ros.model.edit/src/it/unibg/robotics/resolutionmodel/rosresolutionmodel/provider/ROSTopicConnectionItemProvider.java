...
/**
 * This is the item provider adapter for a {@link it.unibg.robotics.resolutionmodel.rosresolutionmodel.ROSTopicConnection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 rosresolutionmodelPackage.Literals.ROS_TOPIC_CONNECTION__PUBLISHER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 rosresolutionmodelPackage.Literals.ROS_TOPIC_CONNECTION__SUBSCRIBER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 rosresolutionmodelPackage.Literals.ROS_TOPIC_CONNECTION__TOPIC,
				 true,
				 false,
				 true,
				 null,
