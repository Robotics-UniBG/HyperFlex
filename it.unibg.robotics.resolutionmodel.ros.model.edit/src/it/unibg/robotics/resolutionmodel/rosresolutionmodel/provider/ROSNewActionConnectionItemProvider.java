...
/**
 * This is the item provider adapter for a {@link it.unibg.robotics.resolutionmodel.rosresolutionmodel.ROSNewActionConnection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ROSNewActionConnectionItemProvider
	 ...
	 * @generated
	 */
	public ROSNewActionConnectionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 rosresolutionmodelPackage.Literals.ROS_NEW_ACTION_CONNECTION__ACTION_SERVER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 rosresolutionmodelPackage.Literals.ROS_NEW_ACTION_CONNECTION__ACTION_CLIENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addActionNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ROSNewActionConnection_actionName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ROSNewActionConnection_actionName_feature", "_UI_ROSNewActionConnection_type"),
				 rosresolutionmodelPackage.Literals.ROS_NEW_ACTION_CONNECTION__ACTION_NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns ROSNewActionConnection.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ROSNewActionConnection"));
	}
	...
	public String getText(Object object) {
		String label = ((ROSNewActionConnection)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ROSNewActionConnection_type") :
			getString("_UI_ROSNewActionConnection_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ROSNewActionConnection.class)) {
