 ...
 * @generated
 */
public class PackageMsgConsumer2ItemSemanticEditPolicy extends
		RosComponentModelBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public PackageMsgConsumer2ItemSemanticEditPolicy() {
		super(RosComponentModelElementTypes.PackageMsgConsumer_3010);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (RosComponentModelVisualIDRegistry.getVisualID(outgoingLink) == PackageMsgConsumerPromoteEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
