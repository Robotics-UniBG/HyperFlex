 ...
 * @generated
 */
public class PackageMsgConsumerName2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PackageMsgConsumerName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RosComponentModelParserProvider
					.getParser(
							RosComponentModelElementTypes.PackageMsgConsumer_3010,
							getParserElement(),
							RosComponentModelVisualIDRegistry
									.getType(it.unibg.robotics.roscomponentmodel.diagram.edit.parts.PackageMsgConsumerName2EditPart.VISUAL_ID));
		}
		return parser;
	}
