...
public class RosComponentModelBaseItemSemanticEditPolicy extends
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public boolean canCreateMsgConsumerSource_4002(MsgConsumer source,
				Topic target) {
			if (source != null) {
			...
			return canExistMsgConsumerSource_4002(source, target);
		}

		/**
		 * @generated
		 */
		public boolean canCreateMsgProducerTarget_4003(MsgProducer source,
				Topic target) {
			if (source != null) {
			...
			return canExistMsgProducerTarget_4003(source, target);
		}

		/**
		 * @generated
		 */
		public boolean canCreatePackageMsgProducerPromote_4004(
				PackageMsgProducer source, MsgProducer target) {
			if (source != null) {
			...
			return canExistPackageMsgProducerPromote_4004(source, target);
		}

		/**
		 * @generated
		 */
		public boolean canCreatePackageMsgConsumerPromote_4005(
				PackageMsgConsumer source, MsgConsumer target) {
			if (source != null) {
				if (source.getPromote() != null) {
					return false;
				}
			...
			return canExistPackageMsgConsumerPromote_4005(source, target);
		}

		/**
		 * @generated
		 */
		public boolean canExistMsgConsumerSource_4002(MsgConsumer source,
				Topic target) {
			return true;
		}
		 ...
		 * @generated
		 */
		public boolean canExistMsgProducerTarget_4003(MsgProducer source,
				Topic target) {
			return true;
		}
		 ...
		 * @generated
		 */
		public boolean canExistPackageMsgProducerPromote_4004(
				PackageMsgProducer source, MsgProducer target) {
			return true;
		}
		 ...
		 * @generated
		 */
		public boolean canExistPackageMsgConsumerPromote_4005(
				PackageMsgConsumer source, MsgConsumer target) {
			return true;
		}
	}
