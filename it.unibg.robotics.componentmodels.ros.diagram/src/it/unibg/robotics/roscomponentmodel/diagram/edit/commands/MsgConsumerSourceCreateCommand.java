 ...
 * @generated
 */
public class MsgConsumerSourceCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MsgConsumerSourceCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof MsgConsumer) {
			return false;
		}
		...
		return RosComponentModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateMsgConsumerSource_4002(getSource(), getTarget());
	}
	 ...
	 * @generated
	 */
	protected MsgConsumer getSource() {
		return (MsgConsumer) source;
	}
