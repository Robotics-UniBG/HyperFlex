...
import it.unibg.robotics.roscomponentmodel.diagram.edit.policies.PackageMsgProducerItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PackageMsgProducerEditPart extends AbstractBorderItemEditPart {
	 ...
	 * @generated
	 */
	public PackageMsgProducerEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PackageMsgProducerItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PackageMsgProducerNameEditPart) {
			((PackageMsgProducerNameEditPart) childEditPart)
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof it.unibg.robotics.roscomponentmodel.diagram.edit.parts.PackageMsgProducerEditPart) {
			types.add(RosComponentModelElementTypes.PackageMsgProducerPromote_4004);
		}
