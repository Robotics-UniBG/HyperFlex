 ...
 * @generated
 */
public class PackageMsgProducerName2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PackageMsgProducerName2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new RosComponentModelTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new ArchitectureModelEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RosComponentModelParserProvider
					.getParser(
							RosComponentModelElementTypes.PackageMsgProducer_3009,
							getParserElement(),
							RosComponentModelVisualIDRegistry
									.getType(it.unibg.robotics.roscomponentmodel.diagram.edit.parts.PackageMsgProducerName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					RosComponentModelEditPartFactory
