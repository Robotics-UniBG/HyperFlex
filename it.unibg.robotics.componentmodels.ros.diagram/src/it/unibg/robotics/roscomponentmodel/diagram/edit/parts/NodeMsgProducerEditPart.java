...
import it.unibg.robotics.roscomponentmodel.diagram.edit.policies.NodeMsgProducerItemSemanticEditPolicy;
 ...
 * @generated
 */
public class NodeMsgProducerEditPart extends AbstractBorderItemEditPart {
	 ...
	 * @generated
	 */
	public NodeMsgProducerEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new NodeMsgProducerItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof NodeMsgProducerNameEditPart) {
			((NodeMsgProducerNameEditPart) childEditPart)
