 ...
 * @generated
 */
public class NodePropertyNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				RosComponentModelVisualIDRegistry
						.getType(it.unibg.robotics.roscomponentmodel.diagram.edit.parts.NodePropertyNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public NodePropertyNameEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		return RosComponentModelElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RosComponentModelParserProvider
					.getParser(
							RosComponentModelElementTypes.NodeProperty_3012,
							getParserElement(),
							RosComponentModelVisualIDRegistry
									.getType(it.unibg.robotics.roscomponentmodel.diagram.edit.parts.NodePropertyNameEditPart.VISUAL_ID));
		}
