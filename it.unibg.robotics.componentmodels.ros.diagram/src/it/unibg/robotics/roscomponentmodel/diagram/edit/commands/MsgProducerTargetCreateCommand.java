 ...
 * @generated
 */
public class MsgProducerTargetCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MsgProducerTargetCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof MsgProducer) {
			return false;
		}
		...
		return RosComponentModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateMsgProducerTarget_4003(getSource(), getTarget());
	}
	 ...
	 * @generated
	 */
	protected MsgProducer getSource() {
		return (MsgProducer) source;
	}
