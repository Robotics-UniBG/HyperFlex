...
import it.unibg.robotics.roscomponentmodel.diagram.edit.policies.OpenDiagramEditPolicy;
import it.unibg.robotics.roscomponentmodel.diagram.edit.policies.Package2CanonicalEditPolicy;
import it.unibg.robotics.roscomponentmodel.diagram.edit.policies.Package2ItemSemanticEditPolicy;
...
public class Package2EditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new Package2CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PackageMsgProducerEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
					PositionConstants.WEST);
			getBorderedFigure().getBorderItemContainer().add(
					((PackageMsgProducerEditPart) childEditPart).getFigure(),
					locator);
			return true;
		}
		if (childEditPart instanceof PackageMsgConsumerEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
					PositionConstants.EAST);
			getBorderedFigure().getBorderItemContainer().add(
					((PackageMsgConsumerEditPart) childEditPart).getFigure(),
					locator);
			return true;
		}
		return false;
