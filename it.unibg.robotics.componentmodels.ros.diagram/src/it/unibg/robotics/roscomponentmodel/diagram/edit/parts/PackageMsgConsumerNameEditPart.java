 ...
 * @generated
 */
public class PackageMsgConsumerNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PackageMsgConsumerNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RosComponentModelParserProvider
					.getParser(
							RosComponentModelElementTypes.PackageMsgConsumer_3007,
							getParserElement(),
							RosComponentModelVisualIDRegistry
									.getType(it.unibg.robotics.roscomponentmodel.diagram.edit.parts.PackageMsgConsumerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
