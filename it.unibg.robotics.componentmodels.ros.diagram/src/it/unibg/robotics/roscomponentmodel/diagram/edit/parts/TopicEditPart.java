...
import it.unibg.robotics.roscomponentmodel.diagram.edit.policies.TopicItemSemanticEditPolicy;
...
public class TopicEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		...
		} else if (relationshipType == RosComponentModelElementTypes.MsgProducerTarget_4003) {
