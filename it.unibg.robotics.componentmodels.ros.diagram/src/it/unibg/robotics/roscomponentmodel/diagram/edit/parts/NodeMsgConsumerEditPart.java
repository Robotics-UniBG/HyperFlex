 ...
 * @generated
 */
public class NodeMsgConsumerEditPart extends AbstractBorderItemEditPart {
	 ...
	 * @generated
	 */
	public NodeMsgConsumerEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new NodeMsgConsumerItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof NodeMsgConsumerNameEditPart) {
			((NodeMsgConsumerNameEditPart) childEditPart)
