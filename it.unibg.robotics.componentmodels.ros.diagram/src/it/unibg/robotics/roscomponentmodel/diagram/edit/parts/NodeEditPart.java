...
import it.unibg.robotics.roscomponentmodel.diagram.edit.policies.NodeCanonicalEditPolicy;
import it.unibg.robotics.roscomponentmodel.diagram.edit.policies.NodeItemSemanticEditPolicy;
...
public class NodeEditPart extends AbstractBorderedShapeEditPart {
	...
	public class ComponentFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureComponentTypeLabel;
		...
		private void createContents() {
			...
			layoutComponentInfo0.numColumns = 3;
			...
			WrappingLabel componentSeparatorLabel1 = new WrappingLabel();

			componentSeparatorLabel1.setText("::");

			componentSeparatorLabel1.setFont(COMPONENTSEPARATORLABEL1_FONT);

			GridData constraintComponentSeparatorLabel1 = new GridData();
			constraintComponentSeparatorLabel1.verticalAlignment = GridData.BEGINNING;
			constraintComponentSeparatorLabel1.horizontalAlignment = GridData.BEGINNING;
			constraintComponentSeparatorLabel1.horizontalIndent = 0;
			constraintComponentSeparatorLabel1.horizontalSpan = 1;
			constraintComponentSeparatorLabel1.verticalSpan = 1;
			constraintComponentSeparatorLabel1.grabExcessHorizontalSpace = false;
			constraintComponentSeparatorLabel1.grabExcessVerticalSpace = false;
			componentInfo0.add(componentSeparatorLabel1,
					constraintComponentSeparatorLabel1);

			fFigureComponentTypeLabel = new WrappingLabel();

			fFigureComponentTypeLabel.setText("<?>");

			fFigureComponentTypeLabel.setFont(FFIGURECOMPONENTTYPELABEL_FONT);

			GridData constraintFFigureComponentTypeLabel = new GridData();
			constraintFFigureComponentTypeLabel.verticalAlignment = GridData.BEGINNING;
			constraintFFigureComponentTypeLabel.horizontalAlignment = GridData.BEGINNING;
			constraintFFigureComponentTypeLabel.horizontalIndent = 0;
			constraintFFigureComponentTypeLabel.horizontalSpan = 1;
			constraintFFigureComponentTypeLabel.verticalSpan = 1;
			constraintFFigureComponentTypeLabel.grabExcessHorizontalSpace = false;
			constraintFFigureComponentTypeLabel.grabExcessVerticalSpace = false;
			componentInfo0.add(fFigureComponentTypeLabel,
					constraintFFigureComponentTypeLabel);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureComponentTypeLabel() {
			return fFigureComponentTypeLabel;
		}
	 ...
	 * @generated
	 */
	static final Font COMPONENTSEPARATORLABEL1_FONT = new Font(
			Display.getCurrent(), Display.getDefault().getSystemFont()
					.getFontData()[0].getName(), 10, SWT.BOLD);
	 ...
	 * @generated
	 */
	static final Font FFIGURECOMPONENTTYPELABEL_FONT = new Font(
			Display.getCurrent(), Display.getDefault().getSystemFont()
					.getFontData()[0].getName(), 10, SWT.BOLD);
