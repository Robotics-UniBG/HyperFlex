 ...
 * @generated
 */
public class MsgProducerTargetReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MsgProducerTargetReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof MsgProducer) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Topic && newEnd instanceof MsgProducer)) {
			return false;
		}
		return RosComponentModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistMsgProducerTarget_4003(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return RosComponentModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistMsgProducerTarget_4003(getOldSource(), getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected MsgProducer getOldSource() {
		return (MsgProducer) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected MsgProducer getNewSource() {
