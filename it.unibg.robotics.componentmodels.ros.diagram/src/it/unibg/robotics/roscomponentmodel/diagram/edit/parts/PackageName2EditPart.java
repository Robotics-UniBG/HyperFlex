 ...
 * @generated
 */
public class PackageName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = RosComponentModelParserProvider
					.getParser(
							...
							RosComponentModelVisualIDRegistry
									.getType(it.unibg.robotics.roscomponentmodel.diagram.edit.parts.PackageName2EditPart.VISUAL_ID));
		}
		return parser;
	}
