 ...
 * @generated
 */
public class PackageMsgProducerNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PackageMsgProducerNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RosComponentModelParserProvider
					.getParser(
							RosComponentModelElementTypes.PackageMsgProducer_3006,
							getParserElement(),
							RosComponentModelVisualIDRegistry
									.getType(it.unibg.robotics.roscomponentmodel.diagram.edit.parts.PackageMsgProducerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
