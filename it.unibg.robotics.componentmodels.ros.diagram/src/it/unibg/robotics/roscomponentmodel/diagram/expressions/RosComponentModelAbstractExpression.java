 ...
 * @generated
 */
public abstract class RosComponentModelAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = RosComponentModelDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected RosComponentModelAbstractExpression(String body,
			EClassifier context) {
		myBody = body;
		myContext = context;
	}
