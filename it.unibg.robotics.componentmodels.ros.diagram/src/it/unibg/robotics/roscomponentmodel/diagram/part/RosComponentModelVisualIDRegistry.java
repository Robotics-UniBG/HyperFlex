...
public class RosComponentModelVisualIDRegistry {
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case NodeMsgProducerEditPart.VISUAL_ID:
			if (NodeMsgProducerNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case NodeMsgConsumerEditPart.VISUAL_ID:
			if (NodeMsgConsumerNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case Package2EditPart.VISUAL_ID:
		...
		case PackageMsgProducerEditPart.VISUAL_ID:
			if (PackageMsgProducerNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case PackageMsgConsumerEditPart.VISUAL_ID:
			if (PackageMsgConsumerNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case PackageMsgProducer2EditPart.VISUAL_ID:
			if (PackageMsgProducerName2EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case PackageMsgConsumer2EditPart.VISUAL_ID:
			if (PackageMsgConsumerName2EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
