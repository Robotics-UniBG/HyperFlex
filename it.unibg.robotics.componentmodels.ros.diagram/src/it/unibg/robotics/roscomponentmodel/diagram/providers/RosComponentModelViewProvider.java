...
public class RosComponentModelViewProvider extends AbstractProvider implements
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case NodeMsgConsumerEditPart.VISUAL_ID:
			return createNodeMsgConsumer_3004(domainElement, containerView,
					index, persisted, preferencesHint);
		case Package2EditPart.VISUAL_ID:
			return createPackage_3005(domainElement, containerView, index,
					persisted, preferencesHint);
		case PackageMsgProducerEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case MsgConsumerSourceEditPart.VISUAL_ID:
			return createMsgConsumerSource_4002(containerView, index,
					persisted, preferencesHint);
		case MsgProducerTargetEditPart.VISUAL_ID:
			return createMsgProducerTarget_4003(containerView, index,
					persisted, preferencesHint);
		case PackageMsgProducerPromoteEditPart.VISUAL_ID:
			return createPackageMsgProducerPromote_4004(containerView, index,
					persisted, preferencesHint);
		case PackageMsgConsumerPromoteEditPart.VISUAL_ID:
			return createPackageMsgConsumerPromote_4005(containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createPackage_3005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RosComponentModelVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createMsgConsumerSource_4002(View containerView, int index,
	 ...
	 * @generated
	 */
	public Edge createMsgProducerTarget_4003(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createPackageMsgProducerPromote_4004(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createPackageMsgConsumerPromote_4005(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
