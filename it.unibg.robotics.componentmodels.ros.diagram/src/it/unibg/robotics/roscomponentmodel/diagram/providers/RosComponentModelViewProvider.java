 ...
 * @generated
 */
public class RosComponentModelViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return ArchitectureModelEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = RosComponentModelVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = RosComponentModelVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!RosComponentModelElementTypes
				...
				if (!ArchitectureModelEditPart.MODEL_ID
						.equals(RosComponentModelVisualIDRegistry.getModelID(op
								.getContainerView()))) {
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		IElementType elementType = getSemanticElementType(op
				.getSemanticAdapter());
		if (!RosComponentModelElementTypes.isKnownElementType(elementType)
				|| (!(elementType instanceof IHintedType))) {
			return false; // foreign element type
		}
		...
		int visualID = RosComponentModelVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(ArchitectureModelEditPart.MODEL_ID);
	 ...
	 * @generated
	 */
	public Node createNodeMsgProducer_3003(EObject domainElement,
	 ...
	 * @generated
	 */
	public Node createNodeMsgConsumer_3004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	...
	private void stampShortcut(View containerView, Node target) {
		if (!ArchitectureModelEditPart.MODEL_ID
				.equals(RosComponentModelVisualIDRegistry
						.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE
					.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put(
					"modelID", ArchitectureModelEditPart.MODEL_ID); //$NON-NLS-1$
