...
public class FeatureItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 featureModelPackage.Literals.FEATURE__REQUIRED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 featureModelPackage.Literals.FEATURE__LOWER_BOUND,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 featureModelPackage.Literals.FEATURE__UPPER_BOUND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(featureModelPackage.Literals.FEATURE__SUB_FEATURES);
			childrenFeatures.add(featureModelPackage.Literals.FEATURE__SUB_COMPOSITE_FEATURES);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(featureModelPackage.Literals.FEATURE__SUB_FEATURES,
				 featureModelFactory.eINSTANCE.createFeature()));

		newChildDescriptors.add
			(createChildParameter
				(featureModelPackage.Literals.FEATURE__SUB_COMPOSITE_FEATURES,
				 featureModelFactory.eINSTANCE.createCompositeFeature()));

		newChildDescriptors.add
			(createChildParameter
				(featureModelPackage.Literals.FEATURE__ATTRIBUTES,
				 featureModelFactory.eINSTANCE.createSimpleAttribute()));
	}
