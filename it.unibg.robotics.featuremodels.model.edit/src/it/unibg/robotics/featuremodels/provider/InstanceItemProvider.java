...
/**
 * This is the item provider adapter for a {@link it.unibg.robotics.featuremodels.Instance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InstanceItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDescritpionPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 featuremodelsPackage.Literals.INSTANCE__ID,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Descritpion feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDescritpionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Instance_descritpion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Instance_descritpion_feature", "_UI_Instance_type"),
				 featuremodelsPackage.Literals.INSTANCE__DESCRITPION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addSelectedFeaturesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Instance_selectedFeatures_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Instance_selectedFeatures_feature", "_UI_Instance_type"),
				 featuremodelsPackage.Literals.INSTANCE__SELECTED_FEATURES,
				 true,
				 false,
				 true,
				 null,
