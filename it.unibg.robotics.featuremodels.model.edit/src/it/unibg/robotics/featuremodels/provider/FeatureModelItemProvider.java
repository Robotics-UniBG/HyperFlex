...
/**
 * This is the item provider adapter for a {@link it.unibg.robotics.featuremodels.FeatureModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureModelItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 featuremodelsPackage.Literals.FEATURE_MODEL__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(featuremodelsPackage.Literals.FEATURE_MODEL__ROOT_FEATURE);
			childrenFeatures.add(featuremodelsPackage.Literals.FEATURE_MODEL__CONSTRAINTS);
			childrenFeatures.add(featuremodelsPackage.Literals.FEATURE_MODEL__INSTANCES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(featuremodelsPackage.Literals.FEATURE_MODEL__ROOT_FEATURE,
				 featuremodelsFactory.eINSTANCE.createFeature()));

		newChildDescriptors.add
			(createChildParameter
				(featuremodelsPackage.Literals.FEATURE_MODEL__CONSTRAINTS,
				 featuremodelsFactory.eINSTANCE.createConstraint()));

		newChildDescriptors.add
			(createChildParameter
				(featuremodelsPackage.Literals.FEATURE_MODEL__INSTANCES,
				 featuremodelsFactory.eINSTANCE.createInstance()));
	}
