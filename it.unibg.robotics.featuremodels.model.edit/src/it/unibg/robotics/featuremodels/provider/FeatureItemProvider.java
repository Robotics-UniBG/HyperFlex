...
/**
 * This is the item provider adapter for a {@link it.unibg.robotics.featuremodels.Feature} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 featuremodelsPackage.Literals.FEATURE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Feature_required_feature", "_UI_Feature_type"),
				 featuremodelsPackage.Literals.FEATURE__REQUIRED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addLowerBoundPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Feature_lowerBound_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Feature_lowerBound_feature", "_UI_Feature_type"),
				 featuremodelsPackage.Literals.FEATURE__LOWER_BOUND,
				 true,
				 false,
				 false,
	...
	protected void addUpperBoundPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Feature_upperBound_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Feature_upperBound_feature", "_UI_Feature_type"),
				 featuremodelsPackage.Literals.FEATURE__UPPER_BOUND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(featuremodelsPackage.Literals.FEATURE__SUB_FEATURES,
		...
		newChildDescriptors.add
			(createChildParameter
				(featuremodelsPackage.Literals.FEATURE__ATTRIBUTES,
				 featuremodelsFactory.eINSTANCE.createSimpleAttribute()));
	}
