...
public class roscomponentmodelAdapterFactory extends AdapterFactoryImpl {
	...
	protected roscomponentmodelSwitch<Adapter> modelSwitch =
		new roscomponentmodelSwitch<Adapter>() {
			...
			@Override
			public Adapter caseMsgProducer(MsgProducer object) {
				return createMsgProducerAdapter();
			}
			@Override
			public Adapter caseMsgConsumer(MsgConsumer object) {
				return createMsgConsumerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link it.unibg.robotics.roscomponentmodel.MsgProducer <em>Msg Producer</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link it.unibg.robotics.roscomponentmodel.MsgConsumer <em>Msg Consumer</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
