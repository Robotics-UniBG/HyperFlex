 ...
 * @generated
 */
public class PackageImpl extends EObjectImpl implements it.unibg.robotics.roscomponentmodel.Package {
	/**
	...
	public EList<Node> getNodes() {
		if (nodes == null) {
			nodes = new EObjectContainmentEList<Node>(Node.class, this, roscomponentmodelPackage.PACKAGE__NODES);
		}
		return nodes;
	}
	 ...
	 * @generated
	 */
	public EList<it.unibg.robotics.roscomponentmodel.Package> getSubPackages() {
		if (subPackages == null) {
			subPackages = new EObjectContainmentEList<it.unibg.robotics.roscomponentmodel.Package>(it.unibg.robotics.roscomponentmodel.Package.class, this, roscomponentmodelPackage.PACKAGE__SUB_PACKAGES);
		}
		return subPackages;
	}
