...
public class roscomponentmodelFactoryImpl extends EFactoryImpl implements roscomponentmodelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case roscomponentmodelPackage.MSG_PRODUCER: return createMsgProducer();
			case roscomponentmodelPackage.MSG_CONSUMER: return createMsgConsumer();
	 ...
	 * @generated
	 */
	public MsgConsumer createMsgConsumer() {
		MsgConsumerImpl msgConsumer = new MsgConsumerImpl();
		return msgConsumer;
	}
