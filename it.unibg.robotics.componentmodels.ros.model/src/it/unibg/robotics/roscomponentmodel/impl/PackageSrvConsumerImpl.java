...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Package Srv Consumer</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link it.unibg.robotics.roscomponentmodel.impl.PackageSrvConsumerImpl#getPromote <em>Promote</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PackageSrvConsumerImpl extends SrvConsumerImpl implements PackageSrvConsumer {
	/**
	 ...
	 * @generated
	 */
	protected PackageSrvConsumerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return roscomponentmodelPackage.Literals.PACKAGE_SRV_CONSUMER;
	}
		...
		if (promote != null && promote.eIsProxy()) {
			...
			if (promote != oldPromote) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, roscomponentmodelPackage.PACKAGE_SRV_CONSUMER__PROMOTE, oldPromote, promote));
			}
		}
		return promote;
	}
	...
	public void setPromote(SrvConsumer newPromote) {
		...
		promote = newPromote;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, roscomponentmodelPackage.PACKAGE_SRV_CONSUMER__PROMOTE, oldPromote, promote));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case roscomponentmodelPackage.PACKAGE_SRV_CONSUMER__PROMOTE:
