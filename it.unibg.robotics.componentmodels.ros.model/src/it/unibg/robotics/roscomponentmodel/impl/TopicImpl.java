 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.roscomponentmodel.impl.TopicImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TopicImpl extends EObjectImpl implements Topic {
	...
	protected EClass eStaticClass() {
		return roscomponentmodelPackage.Literals.TOPIC;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, roscomponentmodelPackage.TOPIC__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case roscomponentmodelPackage.TOPIC__NAME:
				return getName();
		}
