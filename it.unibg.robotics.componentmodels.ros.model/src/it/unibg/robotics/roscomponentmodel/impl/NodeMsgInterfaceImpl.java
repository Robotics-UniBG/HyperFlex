 ...
 * <ul>
 *   <li>{@link it.unibg.robotics.roscomponentmodel.impl.NodeMsgInterfaceImpl#getTopicName <em>Topic Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NodeMsgInterfaceImpl extends MsgInterfaceImpl implements NodeMsgInterface {
	...
	protected EClass eStaticClass() {
		return roscomponentmodelPackage.Literals.NODE_MSG_INTERFACE;
	}
	...
	public void setTopicName(String newTopicName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, roscomponentmodelPackage.NODE_MSG_INTERFACE__TOPIC_NAME, oldTopicName, topicName));
	}
