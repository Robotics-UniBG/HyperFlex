...
/**
 * This is the item provider adapter for a {@link it.unibg.robotics.compositionmodel.ArchitectureModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArchitectureModelItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ArchitectureModel_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ArchitectureModel_name_feature", "_UI_ArchitectureModel_type"),
				 compositionmodelPackage.Literals.ARCHITECTURE_MODEL__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(compositionmodelPackage.Literals.ARCHITECTURE_MODEL__SYSTEM);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(compositionmodelPackage.Literals.ARCHITECTURE_MODEL__SYSTEM,
				 compositionmodelFactory.eINSTANCE.createSystem()));
	}
